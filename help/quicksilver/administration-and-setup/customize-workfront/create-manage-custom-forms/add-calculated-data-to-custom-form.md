   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     ...
     <tr> 
      ...
      <p><b>IMPORTANTE</b>: Antes de escolher um formato, considere o formato correto para o novo campo. O campo de formato não pode ser editado depois que o formulário personalizado é salvo. E a seleção do formato errado pode afetar cálculos futuros e valores agregados em agrupamentos de relatório e lista.</p> </td> 
     </tr> 
    </tbody> 
   </table>
