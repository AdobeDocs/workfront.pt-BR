...
1. Obtenha o URL da imagem fazendo o seguinte:
   ...
   1. Clique com o botão direito e selecione **Copiar local da imagem** ou **Obter link**, dependendo do navegador. Agora você tem o URL para essa imagem específica e pode colá-lo da área de transferência.
...
1. Vá para um projeto, clique no botão **Mais** menu ![](assets/more-icon-45x33.png) ao lado do nome do projeto, clique em **Editar**.
...
1. Clique no cabeçalho da coluna para a variável **Nome do projeto** e, em seguida, clique em **Alternar para modo de texto**.
