...
1. Na página exibida, continue com uma das 6 seções listadas abaixo para definir as configurações para [!UICONTROL Novos Padrões de Tarefa], [!UICONTROL Problemas], [!UICONTROL Exclusão], [!UICONTROL Datas Efetivas] e [!UICONTROL Acesso]:
