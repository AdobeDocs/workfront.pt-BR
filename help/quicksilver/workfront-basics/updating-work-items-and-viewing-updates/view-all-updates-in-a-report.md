...
title: Visualizar todas as atualizações em um relatório de Notas
...
TQID: https://experienceleague.adobe.com/IPzAjX80xFbrcutb-X-9MtEKRftO8kqwW-Dy-KiQVhk
...
# Visualizar todas as atualizações em um relatório de Notas
...
1. Adicione um filtro para **Nota** > **Texto da Nota** > **Não Está em Branco**.
   ...
   ![O campo de texto da observação não está em branco](assets/note-note-text-not-blank-filter.png)
