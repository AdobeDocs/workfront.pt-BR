...
description: Esta página fornece informações sobre as funcionalidades incluídas na versão do segundo trimestre de 2026. Essas melhorias estão previstas para serem disponibilizadas no ambiente de produção ao longo do trimestre.
author: Courtney
...
Esta página fornece informações sobre as funcionalidades incluídas na versão do segundo trimestre de 2026 programada para abril de 2026.

As melhorias nesta página estão disponíveis no ambiente de pré-visualização. Esta página será atualizada com aprimoramentos adicionais à medida que a versão do segundo trimestre de 2026 se aproximar da versão de produção planejada.
...
>
>Observe que, para a versão final de cada trimestre (26.4 deste trimestre), os usuários com o cronograma de lançamento rápido receberão a versão um dia antes (15 de abril de 2026).
>
...
* [Solicitando aprimoramentos](#requesting-enhancements)
...
<table>
    ...
    <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q2-release-activity/26-q2-admin-and-setup.md" class="MCXref xref" xrefformat="{para}">Trimestres personalizados removidos das Preferências do Projeto</a><p>Movemos a área Trimestre personalizado da seção Preferências do projeto. Agora é uma seção independente na Configuração do.</p>
        </td>
    ...
    <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q2-release-activity/26-q2-admin-and-setup.md" class="MCXref xref" xrefformat="{para}">Recolher seção de formulário personalizado por padrão</a><p>Por padrão, todas as seções de um formulário personalizado são expandidas quando o próprio formulário é expandido. Uma nova opção no designer de formulário personalizado permite que você marque uma seção a ser recolhida por padrão quando um usuário abrir o formulário. Essa opção é aplicada no nível de seção, não em campos.</p>
        </td>
     ...
     <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q2-release-activity/26-q2-admin-and-setup.md" class="MCXref xref" xrefformat="{para}">O tipo de campo Rich Text agora está disponível em formulários personalizados</a><p>O novo tipo de campo <b>Rich Text</b> em formulários personalizados é um editor de texto robusto, com opções de formatação como sobrescrito e subscrito, títulos e tabelas, além das opções tradicionais de negrito, itálico, sublinhado, marcadores, numeração, hiperlinks e aspas duplas. O limite de caracteres permanece em 15.000.</p>
        </td>
        <td><p>sexta-feira, 29 de janeiro de 2026</p></td>
        <td><p>sexta-feira, 12 de fevereiro de 2026</p>
            <p>Este recurso foi removido temporariamente do ambiente de produção em 13 de fevereiro de 2026.</p></td>
...
<table>
    ...
    <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q2-release-activity/26-q2-documents.md" class="MCXref xref" xrefformat="{para}">Revisão e aprovação unificadas da plataforma Workfront e Frame.io</a><p></p>
...
<table>
    ...
    <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q2-release-activity/26-q2-projects.md" class="MCXref xref" xrefformat="{para}">Experiência atualizada quando e atribuição única ou em massa de tarefas de modelo </a><p>[!BADGE Off schedule]{type=Neutral}</p><p> Atualizamos a seção Atribuições na caixa Editar Tarefas de Modelo ao editar tarefas de modelo únicas ou em massa.  </p>
        </td>
...
<table>
    ...
    <tr>
        <td>
            ...
            <p>Agora você pode autenticar a Data Connect usando chaves RSA ou conexões PAT (Programmatic Access Tokens), adicionando alternativas mais seguras e flexíveis às credenciais tradicionais de nome de usuário/senha. </p>
        </td>
        <td><p>sexta-feira, 12 de março de 2026</p></td>
        <td><p>sexta-feira, 12 de março de 2026</p></td>
        <td><p>sexta-feira, 16 de abril de 2026</p></td>
   ...
   <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q2-release-activity/26-q2-reports.md" class="MCXref xref" xrefformat="{para}">Pastas de Relatório Compartilháveis</a><p></p>
            <p>Agora você pode organizar e compartilhar relatórios usando pastas de relatórios compartilháveis. Esse novo recurso ajuda as equipes que gerenciam grandes volumes de relatórios a manter um controle de acesso escalável e consistente.</p>
        </td>
        <td><p>sexta-feira, 26 de fevereiro de 2026</p></td>
        <td><p>sexta-feira, 12 de março de 2026</p></td>
        <td><p>sexta-feira, 16 de abril de 2026</p></td>
    ...
    <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q2-release-activity/26-q2-reports.md" class="MCXref xref" xrefformat="{para}">Rótulos de Data Aprimorados para Agrupamentos de Gráficos em Painéis de Tela</a><p></p>
            <p>Gráficos que agrupam dados por data agora exibem rótulos de data mais claros e legíveis. Com esta atualização, os rótulos de data se ajustam dinamicamente com base na opção Agrupar por selecionada, como dia, semana, mês ou ano, tornando os gráficos mais fáceis de ler e interpretar rapidamente.</p><p>Observação: o Canvas Dashboards está atualmente em versão beta.</p>
        </td>
        <td><p>sexta-feira, 26 de fevereiro de 2026</p></td>
        <td><p>sexta-feira, 12 de março de 2026</p></td>
        <td><p>sexta-feira, 16 de abril de 2026</p></td>
...
Novos recursos no Workfront Planning estão disponíveis em Produção. Para obter mais informações sobre os recursos mais recentes, consulte [Atividade de lançamento do segundo trimestre de 2026 do Adobe Workfront Planning](/help/quicksilver/product-announcements/product-releases/planning-release-activity/planning-release-activity-26-q2.md).
...
* Dados de exemplo para lhe dar uma ideia de onde começar
* Treinamento e orientação no produto
* Indicação clara de etapas durante a configuração que são personalizadas para funções específicas.
...
>
> Para campos de seleção múltipla, a versão 2 das Inscrições de evento sempre é enviada como uma matriz. A versão 1 enviava uma matriz se mais de um valor fosse selecionado. Se apenas um valor fosse selecionado, ela enviaria uma string.
