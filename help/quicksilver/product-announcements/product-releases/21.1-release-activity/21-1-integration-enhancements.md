...
title: Aprimoramentos na integração na 21.1
...
# Aprimoramentos na integração na 21.1
...
* Foram expandidos os tipos de notificações que você pode receber no Microsoft Teams. Agora você pode receber notificações sobre uma grande variedade de eventos, como quando alguém comenta em sua folha de horas ou deseja que você aprove um documento.
...
Para aproveitar essa nova funcionalidade, é necessário fazer logon na conta da Microsoft Teams novamente. Você não precisa realizar nenhuma outra ação.
