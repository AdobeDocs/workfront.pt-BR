...
description: A variável [!DNL Adobe Workfront Fusion DocuSign] Os módulos do permitem monitorar e recuperar o status do envelope, pesquisar e recuperar envelopes, ou baixar e enviar um documento para entrar no [!DNL DocuSign] conta.
author: Becky
draft: Probably
...
A variável [!DNL Adobe Workfront Fusion] [!DNL DocuSign] Os módulos do permitem monitorar e recuperar o status do envelope, pesquisar e recuperar envelopes, ou baixar e enviar um documento para entrar no [!DNL DocuSign] conta.
...
Para usar [!DNL DocuSign] módulos, você deve ter uma [!DNL DocuSign] conta.

## Conectar [!DNL DocuSign] para [!DNL Workfront Fusion] {#connect-docusign-to-workfront-fusion}

Para criar uma conexão para o seu [!DNL DocuSign] módulos:

1. Clique em **[!UICONTROL Adicionar]** ao lado da [!UICONTROL Conexão] ao começar a configurar o primeiro [!DNL DocuSign] módulo.
1. Insira o seguinte:
...
1. Continue conforme descrito em [Criar uma conexão com o [!DNL Adobe Workfront Fusion] - Instruções básicas](../../workfront-fusion/connections/connect-to-fusion-general.md#connect).

## [!DNL DocuSign] módulos e seus campos

Ao configurar [!DNL DocuSign] módulos, [!DNL Workfront Fusion] exibe os campos listados abaixo. Junto com esses, [!DNL DocuSign] Os campos podem ser exibidos, dependendo de fatores como seu nível de acesso no aplicativo ou serviço. Um título em negrito em um módulo indica um campo obrigatório.
...
<table style="table-layout:auto">
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>Para obter instruções sobre como conectar seu [!DNL DocuSign] conta para [!DNL Workfront Fusion], consulte <a href="#connect-docusign-to-workfront-fusion" class="MCXref xref">Conectar [!DNL DocuSign] para [!DNL Workfront Fusion]</a> neste artigo.</p> </td> 
  </tr> 
  <tr> 
...
>
>A chamada de API a seguir retorna envelopes a partir da data especificada em seu [!DNL DocuSign] conta:
>
...
<table style="table-layout:auto">
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td>Selecionar <strong>[!UICONTROL Sim]</strong> se quiser incluir o certificado de assinatura de envelope no download.</td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Documentos por ID de Usuário]</td> 
   <td>Selecionar <strong>[!UICONTROL Sim]</strong> se quiser permitir que os destinatários recuperem documentos por ID de usuário. Por exemplo, se um usuário estiver incluído em duas ordens de roteiro diferentes com visibilidades diferentes, o uso dessa opção retornará todos os documentos de ambos os roteiros.</td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Criptografar]</td> 
   <td>Selecionar <strong>[!UICONTROL Sim]</strong> se quiser que os bytes de PDF retornados na resposta sejam criptografados para todos os gerenciadores de chaves configurados no seu [!DNL DocuSign] conta.</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td>Quando definido como <strong>[!UICONTROL Sim]</strong>, todos os campos alterados para o PDF retornado serão realçados em amarelo e as assinaturas ou iniciais opcionais serão contornadas em vermelho.</td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Marca D'Água]</td> 
   <td> <p>Selecionar <strong>[!UICONTROL Não]</strong> para remover a marca d'água dos documentos do PDF.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
Este módulo de ação lê as informações sobre um envelope no [!DNL DocuSign] usando a ID do envelope.
