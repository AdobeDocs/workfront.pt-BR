...
O Workfront usa domínios e endereços IP específicos para comunicação na Web. Eles devem ser adicionados ao incluo na lista de permissões de sua organização para que você possa usar o Workfront em sua organização.
...
>[!IMPORTANT]
>
>Como administrador do Workfront, você deve garantir que esses endereços IP e domínios sejam adicionados ao incluo na lista de permissões de sua organização. Isso é verdade mesmo se você não adicioná-los você mesmo. A Workfront não pode configurar o incluo na lista de permissões de sua organização.
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>O artigo <a href="../../administration-and-setup/get-started-wf-administration/configure-your-firewall.md" class="MCXref xref">Configurar o incluo na lista de permissões do firewall</a> contém a lista de endereços IP e domínios que sua organização deve adicionar ao incluo na lista de permissões. </p> <p>O administrador de rede talvez não tenha acesso ao artigo "Configurar o incluo na lista de permissões do firewall". Nesse caso, você deve fornecê-lo a eles. Não é recomendável imprimir uma cópia impressa (papel). Uma cópia digital permite que o administrador da rede copie e cole os endereços, o que é mais rápido e preciso do que digitar de uma cópia impressa.</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td>Informe o administrador da rede se você usar:
    <ul>
...
>[!IMPORTANT]
>
>Se você adicionar algum desses produtos, integrações ou funcionalidades posteriormente, entre em contato com o administrador da rede para que ele possa ajustar o incluo na lista de permissões.
