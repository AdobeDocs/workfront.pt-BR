...
title: 'Revisar e aprovar integrações nativas: índice do artigo'
description: 'Os seguintes artigos contêm informações sobre integrações de documentos nativos com o Adobe Workfront: GenStudio for Performance Marketing, Creative Cloud Express, Frame.io, Adobe Experience Manager e outros.'
...
# Revisar e aprovar integrações nativas: índice do artigo

<!--Audited: 12/2025-->

Os artigos a seguir contêm informações sobre integrações de documentos nativos com o Adobe Workfront
...
* [Vincular conteúdo e pastas do Experience Manager Assets com o Adobe Cloud Storage](/help/quicksilver/review-and-approve-work/native-integrations/link-aem-assets-cloud-storage.md)
