...
A versão mais recente da extensão de navegador DevTool agora está disponível na Chrome Web Store. É possível adicionar a DevTool ao navegador Chrome sem precisar baixá-la e instalá-la, e a extensão será atualizada automaticamente quando qualquer alteração for feita na DevTool. Você também pode ter a confiança de saber que a loja da web do Chrome validou a DevTool.
...
Para obter mais informações, consulte [Módulos Airtable](../../../workfront-fusion/apps-and-their-modules/airtable-modules.md)
