...
* Anúncios de produto {#product-announcements}
   ...
   * Versões do produto {#product-releases}
      ...
      * Modernização de interface {#interface-modernization}
...
* Noções básicas do Adobe Workfront {#basics}
   ...
   * Prioridades {#priorities}
      ...
      * [Prioridades: Próximas versões](workfront-basics/priorities/priorities-upcoming-releases.md)
...
* Gerenciar Trabalho {#manage-work}
   ...
   * Gerenciamento de Portfolio {#portfolio-management}
      ...
      * Criar e gerenciar programas {#create-and-manage-programs}
         * [Visão geral dos programas em [!DNL Adobe Workfront]](manage-work/portfolios/create-and-manage-programs/programs-overview.md)
...
* Revisar e aprovar trabalhos {#review-and-approve-work}
   ...
   * Revisão e aprovação de ativos e documentos {#document-reviews-and-approvals}
      ...
      * [Visão geral de novas aprovações de documento](review-and-approve-work/document-reviews-and-approvals/document-approvals-overview.md)
      ...
      * Configurar e gerenciar aprovações de ativos e documentos {#manage-asset-review-and-approval}
         ...
         * [Usar novas aprovações e revisões de documentos juntas](review-and-approve-work/document-reviews-and-approvals/doc-approvals-and-proofing.md)
...
* Adobe Workfront Fusion {#adobe-workfront-fusion}
   ...
   * Introdução ao Adobe Workfront Fusion {#get-started-with-workfront-fusion}
      ...
      * [Trabalhar com arquivos grandes no Fusion](/help/quicksilver/workfront-fusion/get-started/fusion-large-files.md)
   ...
   * Cenários no Adobe Workfront Fusion {#scenarios-in-fusion}
      ...
      * [Gerar um segmento de cenário usando IA](/help/quicksilver/workfront-fusion/scenarios/add-a-module-with-ai.md)
