...
1. Ao abrir uma prova, toque no botão **[!UICONTROL Adicionar comentário]** (1).
   ...
   ![toque_no_comentário_botão.png](assets/tap-the-comment-button-350x541.png)
...
1. Siga um destes procedimentos:
   ...
   * Para exibir o comentário completo e suas respostas, toque no próprio comentário.
     ...
     ![responder_a_um_comentário.png](assets/reply-to-a-comment-350x543.png)
   ...
   * Para aplicar uma ação em um comentário:
      ...
      1. Toque em **[!UICONTROL Adicionar ação]** (2).
         ...
         ![ações_em_comentários.png](assets/actions-on-comments-350x543.png)
...
1. Em uma prova aberta, toque em **Adicionar comentário** (1).
   ...
   ![toque_no_add_comment_button.png](assets/tap-the-add-comment-button-350x541.png)
...
1. Toque em **[!UICONTROL Cancelar]** (8) se desejar descartar a marcação.
   ...
   ![add_a_markup.png](assets/adding-a-markup-350x543.png)
   ...
   ![removendo_uma_marcação.png](assets/removing-a-markup-350x543.png)
