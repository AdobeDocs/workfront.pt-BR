...
title: Nova experiência de comentário
description: Uma atualização da experiência de comentário no Adobe Workfront está em desenvolvimento no momento. Esta atualização inclui uma nova interface, novos recursos e melhor desempenho na seção Atualizações de objetos selecionados.
author: Alina
...
<td>Reagir aos comentários (Curtir) 
  ...
  <tr>
   <td>Veja novos comentários em tempo real (inclui ver quando um comentário é excluído)
   </td>
   <td> 
   </td>
   <td>✓
...
Para obter informações sobre os recursos lançados recentemente, consulte [Nova atividade de versão de experiência beta de comentário](../../betas/new-commenting-experience-beta/new-commenting-beta-experience-release-activity.md).

## Localize a nova experiência de comentário

Atualmente, a nova experiência de comentário é compatível com os seguintes objetos ao visualizar a seção Atualizações nas seguintes versões do Workfront:
...
1. Ative o **Beta de comentários** alterne no canto superior direito da área Atualizações.
1. Clique em **Concordar** na caixa Contrato beta. Isso permite a nova experiência de comentário para o objeto selecionado.
