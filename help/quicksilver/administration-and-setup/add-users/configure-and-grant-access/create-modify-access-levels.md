...
1. Selecione o nível de acesso que você deseja copiar e personalizar e clique no **ícone Copiar** ![ícone Copiar](assets/copy-icon.png).

   Ou

   Se você estiver editando um nível de acesso existente, selecione o nível de acesso clicando na caixa à esquerda desse nível de acesso e clique no ícone **Editar** ![Ícone Editar](assets/edit-icon.png).
...
1. Na caixa exibida, siga um destes procedimentos para começar a configurar o nível de acesso personalizado:
   ...
   <tr> 
      <td role="rowheader">Tipo de licença do Planning</td> 
      <td><p>Este campo é visível somente para clientes que também compraram um pacote do Workfront Planning, além de um pacote do Workflow.</p>
      <p>A licença selecionada determina quais configurações estão disponíveis para usuários com este nível de acesso. </p>
      <p>Escolha entre as seguintes opções:</p>
      <ul><li>Padrão</li>
      <li>Colaborador</li>
      <li>Nenhum</li>
     </ul> 
      Para obter mais informações, consulte <a href="/help/quicksilver/planning/access/access-overview.md">Visão geral sobre acesso ao Adobe Workfront Planning</a> 
      <p><b>IMPORTANTE</b></p>
      <p>As licenças do Planning e do Fluxo de trabalho funcionam juntas para conceder aos usuários acesso ao Workfront. </p>
      <p>Você pode conceder a um usuário diferentes níveis de tipos de licença entre os tipos de licença do Workflow e do Planning, mas a licença do Workflow não pode ser inferior à licença do Planning. </p>
      <p>Por exemplo, você pode conceder uma licença do Workflow Standard a um usuário e uma licença do Planning Contributor, mas não pode conceder a ele uma licença do Workflow Contributor e uma licença do Planning Standard.</p>

   </td> 
     </tr>

   <tr> 
      <td role="rowheader">Tipo de licença de fluxo de trabalho</td> 
      <td>Certifique-se de que a licença selecionada aqui seja a mais associada ao tipo de nível de acesso que você está criando ou editando. A licença selecionada determina quais configurações estão disponíveis para o nível de acesso.
...
1. Clique em **Definir restrições adicionais** e defina qualquer uma das restrições a seguir para o nível de acesso.
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     ...
     <tr>
      <td role="rowheader">Permitir que os usuários acessem Marcas</td> 
      <td>Permite que os usuários acessem e gerenciem Marcas GenStudio na Workfront. Para obter mais informações, consulte <a href="/help/quicksilver/administration-and-setup/add-users/configure-and-grant-access/grant-access-brands.md" class="MCXref xref">Conceder acesso às permissões de marca</a>.</td> 
     </tr>
    </tbody> 
   </table>


1. (Opcional) Para impedir que usuários com este nível de acesso vejam campos específicos, adicione os campos na seção Adicionar campos restritos.</span>

   Você pode pesquisar campos nativos e personalizados nesta seção. Há um limite de 20 campos restritos.

   Os campos são restritos quando o nível de acesso é atribuído a um usuário como seu nível de acesso principal ou por meio de um perfil de negócios. Para obter mais informações sobre perfis empresariais, consulte [Visão geral sobre perfis empresariais](/help/quicksilver/administration-and-setup/add-users/create-and-manage-users/business-profiles.md).

   Um campo restrito ainda é visível para os usuários no sistema, mas aparece em branco ou exibe N/D em vez de dados reais.
