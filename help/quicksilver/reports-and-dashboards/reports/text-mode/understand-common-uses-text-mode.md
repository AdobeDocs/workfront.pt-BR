...
* Crie campos personalizados calculados personalizados em um formulário personalizado.\
  Para obter mais informações sobre campos personalizados calculados, consulte a [Usar o modo de texto em campos personalizados calculados](#use-text-mode-in-calculated-custom-fields) neste artigo.
...
* Criar prompts personalizados. Você só pode criar prompts personalizados usando o Modo de texto.
  ...
  Para obter informações sobre a criação de prompts personalizados, consulte [Adicionar um prompt a um relatório](../../../reports-and-dashboards/reports/creating-and-managing-reports/add-prompt-report.md).
...
Para obter informações, consulte [Exemplo de campo personalizado calculado: exibir um carimbo de data e hora de Status em um Formulário personalizado](../../../reports-and-dashboards/reports/calc-cstm-data-reports/example-status-timestamp-in-calculated-field.md).
...
* A seção [Exemplos de filtros do modo de texto que abrangem vários níveis na hierarquia do objeto](../../../reports-and-dashboards/reports/text-mode/create-complex-text-mode-filters-using-exists-statements.md#examples) no artigo [Criar filtros complexos do Modo de Texto usando instruções EXISTS](../../../reports-and-dashboards/reports/text-mode/create-complex-text-mode-filters-using-exists-statements.md)
* A seção [Criar filtros de modo de texto complexo para objetos ausentes](../../../reports-and-dashboards/reports/text-mode/create-complex-text-mode-filters-using-exists-statements.md#missing-object-filters) no artigo [Criar filtros complexos do Modo de Texto usando instruções EXISTS](../../../reports-and-dashboards/reports/text-mode/create-complex-text-mode-filters-using-exists-statements.md)
