...
title: Visão geral dos pools de recursos
description: Como gerente de recursos, você pode gerenciar seus recursos adicionando usuários a pools de recursos.
author: Alina
...
Como gerente de recursos, você pode gerenciar seus recursos adicionando usuários a pools de recursos.

O gerenciamento eficiente de recursos não pode ocorrer sem preencher seus pools de recursos com usuários e anexá-los a projetos. Isso é um pré-requisito para usar a funcionalidade de Planejamento de Recursos.

Para obter mais informações sobre os pré-requisitos necessários antes de começar a usar o Planejamento de Recursos, consulte a seção &quot;Pré-requisitos para trabalhar no Planejador de Recursos&quot; em [Visão geral do Planejador de recursos](../../../resource-mgmt/resource-planning/get-started-resource-planner.md).

Para obter informações sobre como criar e gerenciar pools de recursos, consulte os seguintes artigos:
...
* Um Pool de Recursos é uma coleção de usuários que são necessários ao mesmo tempo para a conclusão de um projeto.
* Um Pool de Recursos pode ser compartilhado em vários projetos, programas ou portfólios quando associado a todos os projetos nos programas e portfólios.
* Você pode criar um Pool de Recursos e preenchê-lo com usuários existentes após sua criação, ou criar o Pool de Recursos e associá-lo a um usuário existente ou a um novo usuário durante a criação ou edição do usuário.
* Depois de preencher seus Pools de Recursos com usuários, você pode associá-los a projetos e modelos e gerenciar a alocação de usuários aos projetos com mais eficiência.
* Você pode associar quantos Pools de Recursos forem necessários a um projeto, modelo ou usuário.

## Critérios para associar usuários a um pool de recursos

Há várias maneiras de estruturar seus pools de recursos.

Recomendamos as seguintes abordagens:

* Você pode ter todos os usuários no mesmo Pool de Recursos pertencentes à mesma equipe.

   Por exemplo, se você quiser que todos os usuários de uma equipe de marketing estejam disponíveis para um projeto, você gostaria de um Pool de Recursos de Marketing, onde você adicionaria todos os usuários dessa equipe. Em seguida, você pode associar o Pool de Recursos de Marketing aos projetos aos quais os membros dessa equipe estão atribuídos.

* Você pode fazer com que todos os usuários no mesmo Pool de Recursos cumpram funções semelhantes, especialmente se as funções estiverem em alta demanda e precisarem ser orçadas separadamente.

   Por exemplo, você pode ter recursos externos que funcionam como Consultores e que você deseja ter disponíveis para um projeto de vez em quando. Você pode criar um pool de recursos para consultores que pode ser anexado a seus projetos, onde pode colocar ambos os usuários que são consultores internos ou externos.

* Você também pode criar Grupos de Recursos por departamento ou centro de custos.
* Não recomendamos adicionar todos os usuários do sistema a um pool de recursos se você tiver um grande número de usuários ou se gerenciar recursos de um grande número de projetos de cada vez.
