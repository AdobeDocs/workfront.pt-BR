...
description: "Exibição: folga pessoal do usuário"
author: Nolan
...
1. Clique no ícone ![](assets/main-menu-icon.png) do **Menu principal** no canto superior direito e em **Relatórios > Novo relatório**.
