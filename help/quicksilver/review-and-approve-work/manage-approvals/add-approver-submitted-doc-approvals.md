...
title: Adicionar aprovadores adicionais às aprovações de documento enviadas
description: Você pode adicionar aprovadores adicionais a uma aprovação de documento diretamente da área inicial.
author: Courtney
...
# Adicionar aprovadores adicionais às aprovações de documento enviadas

Você pode adicionar aprovadores adicionais a uma aprovação de documento diretamente da área inicial.
...
1. Selecione um **Documento** aprovação.

1. Clique em **Gerenciar aprovações** no canto superior direito do painel direito.
1. No **Pedir que alguém aprove este documento** digite o nome do aprovador.

   Se o administrador do Adobe Workfront tiver habilitado a capacidade de colaborar com pessoas que não usam o Workfront, conforme descrito em [Configurar preferências de segurança do sistema](../../administration-and-setup/manage-workfront/security/configure-security-preferences.md), você pode digitar os endereços de email para incluí-los.
