...
Atualizamos a aparência do Workfront Fusion para refletir mais detalhadamente a aparência de outros produtos de Adobe. Essa alteração na aparência mais limpa permite uma experiência mais consistente ao trabalhar em vários produtos de Adobe.

Essa atualização também oferece aprimoramentos de desempenho para navegação mais rápida.
