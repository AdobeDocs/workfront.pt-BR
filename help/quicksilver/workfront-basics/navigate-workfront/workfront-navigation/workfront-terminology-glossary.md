...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <p>Para um projeto, [!DNL Workfront] usa a seguinte fórmula para calcular o [!UICONTROL Custo Efetivo de Despesas]:</p> <p><code>Project Actual Expense Cost = SUM (All Project Actual Expense Costs) + SUM (All Tasks Actual Expense Costs)</code> <br> </p> 
   <!--
...
<tr> 
   ...
   <td>O processo de personalização [!DNL Workfront] para dar à interface uma aparência que reflete sua empresa usando suas cores e logotipos.</td> 
  </tr> 
  <tr> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Os itens de trabalho e relatórios de uma organização, bem como os grupos de usuários que os gerenciam na [!UICONTROL Workfront]. Os objetos podem ser:</p> 
    <ul> 
     <li>[!UICONTROL Portfolio]</li> 
     <li>[!UICONTROL Programas]</li> 
     <li>[!UICONTROL Projetos]</li> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Indica o objeto pai de outro objeto. Por exemplo, um documento anexado a uma tarefa tem o nome da tarefa no campo [!UICONTROL Origem] de um relatório ou exibição [!UICONTROL Documento]; um problema registrado em um projeto tem o nome do projeto no campo [!UICONTROL Origem] de um relatório ou exibição de Problema. </p> </td> 
  </tr> 
  <tr> 
