...
Com o [!DNL Adobe Workfront Fusion] [!DNL Adobe Creative Cloud Libraries] você pode iniciar um cenário quando um elemento ou biblioteca é criado ou atualizado. Também é possível fazer upload, recuperar, arquivar ou listar elementos ou fazer uma chamada para o [!DNL Adobe Creative Cloud Libraries] API.
...
Para usar [!DNL Adobe Creative Cloud Libraries] módulos, você deve ter um [!UICONTROL Adobe Creative Cloud] conta.

## [!UICONTROL Bibliotecas do Adobe Creative Cloud] módulos e seus campos

Ao configurar [!UICONTROL Bibliotecas do Adobe Creative Cloud] módulos, [!DNL Workfront Fusion] exibe os campos listados abaixo. Junto com esses, [!DNL Adobe Creative Cloud Libraries] Os campos podem ser exibidos, dependendo de fatores como seu nível de acesso no aplicativo ou serviço. Um título em negrito em um módulo indica um campo obrigatório.
...
<table style="table-layout:auto"> 
  ...
  <tbody>
    <tr>
      ...
      <td>Para obter instruções sobre como conectar seu [!DNL Adobe Creative Cloud] conta para [!DNL Workfront Fusion], consulte <a href="../../workfront-fusion/connections/connect-to-fusion-general.md" class="MCXref xref" data-mc-variable-override="">Criar uma conexão com o [!DNL Adobe Workfront Fusion] - Instruções básicas.</td>
    </tr>
    <tr>
