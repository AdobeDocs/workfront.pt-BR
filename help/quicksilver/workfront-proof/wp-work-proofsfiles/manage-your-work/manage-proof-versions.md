...
description: Gerenciar comentários em várias versões ou revisões de um trabalho pode ser um enorme desafio. [!DNL Workfront Proof] simplifica esse processo permitindo que você crie e compare várias versões de uma prova.
author: Courtney
