...
* Não há suporte para campos que dependem de dados calculados. Por exemplo, se o Campo A for um campo calculado e as opções do Campo B forem derivadas do Campo A, o Preenchimento de formulário não poderá preencher automaticamente o Campo B.
