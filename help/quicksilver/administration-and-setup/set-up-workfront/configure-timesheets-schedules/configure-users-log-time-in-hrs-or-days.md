...
TQID: https://experienceleague.adobe.com/ECf14qjOo9A0TON0O9Y0oGXel-iHwJ61ER-u7a77Njc
product_v2:
...
Os usuários com uma licença do [!UICONTROL Standard] ou do [!UICONTROL Planner] podem configurar se farão o logon por [!DNL Adobe Workfront] em horas ou dias. Como administrador do [!DNL Workfront], você pode definir essa configuração para usuários individuais ou vários usuários completos em sua organização. Por padrão, os usuários registram tempo em horas.
