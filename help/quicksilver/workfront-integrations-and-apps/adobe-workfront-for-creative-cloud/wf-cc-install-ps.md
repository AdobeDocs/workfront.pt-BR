...
## Instale o [!DNL Adobe Workfront for Photoshop] plugin para a sua organização
...
## Instale o [!DNL Adobe Workfront for Photoshop] plugin individualmente

Você pode instalar o [!DNL Adobe Workfront for Photoshop] para você mesmo a partir do [!DNL Adobe Exchange].
