...
# Visão geral do gerenciamento de portfólios
...
Para obter mais informações sobre portfólios, consulte [Noções básicas sobre a metodologia de portfólio](../../../manage-work/portfolios/portfolios-overview/portfolio-overview.md). Para obter mais informações sobre como aprovar um Business Case, consulte [Aprovar um Business Case](../../../manage-work/projects/define-a-business-case/approve-business-case.md).
