---
title: Exibir e gerenciar perfis empresariais
...
## Criar um perfil comercial para um usuário

{{step-1-to-users}}

1. Selecione o usuário ao qual deseja adicionar um perfil comercial.
1. Na navegação à esquerda da página desse usuário, clique em **Perfis comerciais**.
1. Clique em **Adicionar Perfil Comercial**.
1. Selecione o nível de acesso que esse perfil de negócios representa.
