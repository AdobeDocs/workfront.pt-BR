...
title: Configure como o Workfront calcula a hora do recurso e a disponibilidade do FTE para a área de Agendamento
description: O administrador do Adobe Workfront determina como a Workfront calcula a disponibilidade de recursos e a alocação de usuários no nível do sistema (considerando horas e a disponibilidade do FTE) ao configurar as preferências do Gerenciamento de Recursos.
author: Alina
...
# Configure como o Workfront calcula a hora do recurso e a disponibilidade do FTE para a área de Agendamento
...
O administrador do Adobe Workfront determina como a Workfront calcula a disponibilidade de recursos e a alocação de usuários no nível do sistema (considerando horas e a disponibilidade do FTE) ao configurar as preferências do Gerenciamento de Recursos.

Eles podem optar por usar um dos seguintes procedimentos:
...
* Ao permitir que o Workfront atribua recursos automaticamente, conforme descrito no seguinte artigo:
...
* Ao exibir indicadores de alocação, conforme descrito no seguinte artigo:

   * A seção &quot;Indicadores de alocação&quot; no artigo  [Gerenciar alocações de usuários nas áreas de Agendamento](../../resource-mgmt/resource-scheduling/manage-allocations-scheduling-areas.md).
