...
* Anúncios de produtos {#product-announcements}
   ...
   * Versões do produto {#product-releases}
      ...
      * Versão 23.2 {#release-23-2}
         ...
         * [Atividade de lançamento da versão 23.2: semana de 13 de fevereiro de 2023](product-announcements/product-releases/23.2-release-activity/23-2-feb-13.md)
         * [Atividade de versão 23.2: Semana de 6 de fevereiro de 2023](product-announcements/product-releases/23.2-release-activity/23-2-feb-6.md)
         * [Atividade de versão 23.2: semana de 23 de janeiro de 2023](product-announcements/product-releases/23.2-release-activity/23-1-jan-23.md)
...
* Administração e configuração {#administration-and-setup}
   ...
   * Personalizar o Adobe Workfront {#customize}
      ...
      * Formulários personalizados {#custom-forms}
         ...
         * [Adicionar lógica de exibição e ignorar lógica](administration-and-setup/customize-workfront/create-manage-custom-forms/display-or-skip-logic-custom-form.md)
   ...
   * Dicas, truques e solução de problemas para administração e configuração {#admin-setup-tips}
      ...
      * [Atualizar opções de atualização automática em níveis de acesso](administration-and-setup/tips-tricks-and-troubleshooting/update-auto-upgrade-in-access-levels.md)
...
* Gerenciar recursos {#manage-resources}
   ...
   * Agendamento de recursos {#resource-scheduling}
...
* Adobe Workfront Goals {#adobe-workfront-goals}
   ...
   * Revisão de meta e as seções Metas da Adobe Workfront {#goal-review-and-adobe-workfront-goals-sections}
      ...
      * [Analisar metas na seção Publicação de metas da Adobe Workfront](workfront-goals/goal-review-and-workfront-goals-sections/review-goals-in-pulse.md)
