...
1. (Opcional) Se estiver editando um relatório de Tabela, edite as informações conforme necessário nas seguintes seções:
   ...
   * **Configurações do grupo**
   ...
   Para editar filtros ou agrupamentos, consulte [Filtrar um relatório em um Painel da Tela](/help/quicksilver/reports-and-dashboards/canvas-dashboards/manage-reports/filter-a-report.md) e [Agrupar dados de relatório em um Painel da Tela](/help/quicksilver/reports-and-dashboards/canvas-dashboards/manage-reports/group-report-data.md).
