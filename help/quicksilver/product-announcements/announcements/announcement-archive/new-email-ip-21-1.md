...
title: Novos endereços IP para email do Adobe Workfront na versão 21.1
...
Adicione os seguintes endereços IP ao incluo na lista de permissões para garantir que os usuários continuem recebendo emails:
...
(Para obter contexto adicional sobre o incluo na lista de permissões e outros endereços IP que já podem ter sido adicionados ao seu incluo na lista de permissões, consulte [Configurar o incluo na lista de permissões do firewall](../../../administration-and-setup/get-started-wf-administration/configure-your-firewall.md).)
