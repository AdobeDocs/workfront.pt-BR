...
1. (Opcional) Se o campo personalizado de seleção múltipla já estiver neste formulário e se ele já estiver anexado a objetos, habilite a opção **Atualizar cálculos anteriores (em segundo plano)**.
