...
Responder a um comentário ou resposta é diferente dependendo de qual experiência e qual objeto você selecionar.

### Responder a uma atualização ou resposta na seção Atualizações atuais
...
### Responder a um comentário ao usar a experiência Beta de comentário

1. Vá para o objeto ao qual deseja adicionar uma resposta.
1. Clique em **Atualizações**, em seguida, clique no botão **Comentários** para o objeto e localize o comentário ou resposta ao qual deseja responder.
