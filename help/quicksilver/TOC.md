...
* Administração e configuração {#administration-and-setup}
   ...
   * Adicionar usuários {#add-users}
      ...
      * Como os níveis de acesso funcionam {#access-levels}
         ...
         * [Acesso a objetos por tipo de licença](administration-and-setup/add-users/access-levels-and-object-permissions/access-to-objects-and-areas-by-license-type.md)
...
* Noções básicas do Adobe Workfront {#basics}
   ...
   * Atualizar itens de trabalho e visualizar atualizações {#update-work-items-view-updates}
      ...
      * [Visão geral da guia Atualizações](workfront-basics/updating-work-items-and-viewing-updates/updates-tab-overview.md)
...
* Agile {#agile}
   ...
   * Ágil em projetos {#agile-in-projects}
      * [Ágil em projetos](agile/agile-in-projects/agile-in-projects.md)
      * [Projeto Ágil](agile/agile-in-projects/use-agile-on-a-project.md)
