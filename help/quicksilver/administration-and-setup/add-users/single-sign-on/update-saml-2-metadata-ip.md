...
TQID: https://experienceleague.adobe.com/Qry3z-8ySVGsuyznB0p27jQgIpcrTYOPX5svaeDPpf8
...
>[!IMPORTANT]
>
>O procedimento descrito nesta página foi aplicado apenas a organizações que ainda não foram integradas à Adobe Admin Console.
>
>Como todas as organizações agora estão integradas à Adobe Admin Console, o procedimento não está mais disponível.
>
>Para mapear atributos de usuário em organizações que foram integradas à Adobe Admin Console, consulte [Mapear atributos de usuário](/help/quicksilver/administration-and-setup/add-users/create-and-manage-users/map-user-attributes.md#map-user-attributes-in-the-adobe-unified-experience) no artigo Mapear atributos de usuário.
