...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <td> <p>Versão de pré-visualização do Beta: 17 de janeiro de 2020</p> <p>Versão de produção: com a versão 2020.1</p> </td> 
  </tr> 
 </tbody> 
</table>
...
* [Listar aprimoramentos](#list-enhancements)
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/2020.1-release-activity/2020-1-list-enhancements.md#new" class="MCXref xref" xrefformat="{para}" data-mc-conditions="OnlineOrPDF.OnlineOnly">Novo modo de salvamento ao fazer alterações em uma lista de tarefas: o modo de Planejamento de Linha do Tempo</a><!--
   ...
   <td> <p>Versão de pré-visualização do Beta: 14 de março de 2020</p> <p>Versão de produção: com a versão 2020.1</p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/2020.1-release-activity/2020-1-list-enhancements.md#improved" class="MCXref xref" xrefformat="{para}" data-mc-conditions="OnlineOrPDF.OnlineOnly">Navegação aprimorada de todas as novas listas com diferenciação de agrupamento clara</a><!--
  ...
  <tr data-mc-conditions=""> 
   ...
   <td> <p>Versão de pré-visualização do Beta: 17 de janeiro de 2020</p> <p>Versão de produção: N/D</p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <td> <p>Versão de pré-visualização do Beta: 8 de janeiro de 2020</p> <p>Versão de produção: 8 de janeiro de 2020</p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
  ...
  <tr> 
   <td> <p><a href="../../../product-announcements/product-releases/2020.1-release-activity/2020-1-list-enhancements.md#updated" class="MCXref xref" xrefformat="{para}" data-mc-conditions="OnlineOrPDF.OnlineOnly">Aparência e comportamento atualizados de novas listas</a><!--
     ...
     --><span style="color: #ff0000;">(Algumas atualizações de listas foram removidas da versão)</span> </p> <p>As listas de Projetos, Tarefas e Horas agora têm uma aparência atualizada. </p> <p>Quando esses recursos foram originalmente lançados para Pré-visualização, eles estavam disponíveis para todos os relatórios e listas, exceto as listas nas áreas Configuração e Relatórios. Esses recursos agora estão disponíveis apenas para listas de Projetos, Tarefas e Horas.</p> </td> 
   <td> <p>Versão de pré-visualização do Beta: 20 de dezembro de 2019</p> <p>Versão de produção planejada: com a versão 2020.1</p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Versão de pré-visualização do Beta: 14 de março de 2020</p> <p>Versão de produção: a ser definida (esse recurso estará disponível no ambiente de produção algum tempo após a versão 2020.1).</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>Versão de pré-visualização do Beta: 31 de janeiro de 2020</p> <p>Versão de produção: com a versão 2020.1</p> </td> 
  </tr> 
  <tr> 
   <td> <p><a href="../../../product-announcements/product-releases/2020.1-release-activity/2020-1-resource-management-enhancements.md#the" class="MCXref xref" xrefformat="{para}" data-mc-conditions="OnlineOrPDF.OnlineOnly">A configuração Exibir Horas Efetivas foi removida do Planejador de Recursos</a><!--
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <td> <p>Versão de pré-visualização do Beta: 14 de março de 2020</p> <p>Versão de produção: 26 de março de 2020</p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <td> <p>Versão de pré-visualização do Beta: 14 de fevereiro de 2020</p> <p>Versão de produção: com a versão 2020.1</p> </td> 
  </tr> 
  <tr> 
   <td> <p><a href="../../../product-announcements/product-releases/2020.1-release-activity/2020-1-project-enhancements.md#addition2" class="MCXref xref" xrefformat="{para}" data-mc-conditions="OnlineOrPDF.OnlineOnly">Campos adicionais adicionados às Linhas de Base e Tarefas de Linha de Base</a><!--
  ...
  <tr> 
   <td> <p><a href="../../../product-announcements/product-releases/2020.1-release-activity/2020-1-project-enhancements.md#issues" class="MCXref xref" xrefformat="{para}" data-mc-conditions="OnlineOrPDF.OnlineOnly">Problemas com o status "Aprovação Fechada Pendente" são considerados incompletos</a><!--
   ...
   <td> <p>Versão de pré-visualização do Beta: 6 de dezembro de 2019</p> <p>Versão de produção planejada: com a versão 2020.1</p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Versão de visualização do Beta: 6 de março de 2020</p> <p>Versão de produção: com a versão 2020.1</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>Versão de pré-visualização do Beta: 30 de janeiro de 2020</p> <p>Versão de produção planejada: com a versão 2020.1</p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> <p><a href="../../../product-announcements/product-releases/2020.1-release-activity/2020-1-mobile-enhancements.md#seamless" class="MCXref xref" xrefformat="{para}">Experiência perfeita entre o aplicativo móvel e a Web</a> </p> <p>Para tornar sua experiência mais consistente ao usar o Workfront no aplicativo móvel e na Web, qualquer personalização da navegação secundária do painel esquerdo nos modelos de layout novos ou existentes é refletida automaticamente no aplicativo móvel.</p> </td> 
   <td> <p>Versão de pré-visualização do Beta: N/D</p> <p>Versão de produção: com a versão 2020.1</p> </td> 
  </tr> 
  <tr> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Versão de pré-visualização do Beta: 29 de janeiro de 2020</p> <p>Versão de produção: 30 de janeiro de 2020</p> </td> 
  </tr> 
  <tr> 
   ...
   <td> <p>Versão de pré-visualização do Beta: 20 de dezembro de 2019</p> <p>Versão de produção: 20 de dezembro de 2019</p> </td> 
  </tr> 
 </tbody> 
</table>
