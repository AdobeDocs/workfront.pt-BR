...
>[!NOTE]
>
>Os usuários devem ser adicionados ao Adobe Admin Console para serem acessíveis em chamadas de API. Usuários somente Workfront não podem ser acessados usando a API do Adobe Planning.
>
