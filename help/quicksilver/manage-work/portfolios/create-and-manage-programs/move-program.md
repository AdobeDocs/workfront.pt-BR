...
1. No campo **[!UICONTROL Adicionar programas a este Portfolio]**, digite o nome de um programa e selecione-o quando ele for exibido na lista. <!--see the name of this field, I suggested changes here-->
