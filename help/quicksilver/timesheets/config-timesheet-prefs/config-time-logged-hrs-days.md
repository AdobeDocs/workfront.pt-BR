...
title: Configurar se o tempo é registrado em horas ou dias
...
# Configurar se o tempo é registrado em horas ou dias
...
## Configurar registro de tempo

1. Siga um destes procedimentos, dependendo do objetivo e do nível de acesso no sistema:

   * **Usuário padrão ou do plano configurando o log de tempo para você mesmo:** clique na imagem do seu perfil na área de navegação superior e clique em **[!UICONTROL Perfil do Workfront]**. Em seguida, clique no ícone **Mais** ao lado do seu nome e selecione **Editar**.
...
1. Na caixa de diálogo Perfil de usuário, na seção **Planejamento de Recursos**, localize a opção **Registrar tempo em**.
