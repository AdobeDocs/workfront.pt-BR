...
1. Preencha os detalhes para o Estágio 1 do Caminho 1:
   ...
   <tr class="preview">
   <td><span class="preview"><strong>Adicionar pessoas ou equipes na visualização (opcional)</strong></span></td>
    <td><span class="preview">Comece a digitar um nome de usuário, equipe ou endereço de email. Os participantes são opcionais nos templates. Você pode optar por adicioná-los quando o modelo for aplicado a um documento.<br>
...
>[!NOTE]
>
>Novos modelos são visíveis somente para você. Para compartilhar, editar ou excluir um modelo, consulte [Gerenciar modelos de aprovação](/help/quicksilver/review-and-approve-work/document-reviews-and-approvals/manage-document-approvals/manage-approval-templates.md).
