...
1. (Condicional) Se você estiver enviando a solicitação da Nova experiência de solicitação e sua organização permitir o **Preenchimento de formulário** possibilitado pela IA, você poderá carregar documentos, emails ou links para outros objetos (projeto, tarefas ou problemas) como prompts. A IA usa esses itens para preencher o formulário e você pode aceitar ou rejeitar as sugestões de IA antes de enviar a solicitação.
