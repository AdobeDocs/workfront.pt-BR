...
1. Clique no botão **[!UICONTROL Comentários]** no ícone na [!DNL Workfront] ou na **[!UICONTROL Comentários]** guia . ![Jira_comments_icon.png](assets/jira-comments-icon.png)
