...
1. Substitua o texto pelo seguinte código:
   ...
   <pre>group.0.linkedname=project:sponsor:name<br>group.0.name=<br>group.0.valuefield=projeto:sponsor:name<br>group.0.valueformat=HTML<br>textmode=true<br></pre>
