---
title: Melhorias no gerenciamento financeiro do terceiro trimestre de 2026
description: Melhorias no gerenciamento financeiro do terceiro trimestre de 2026
author: Becky
...
## Adicionar um cartão de taxa a um modelo
...
Para obter informações, consulte [Anexar um cartão de taxa a um modelo](/help/quicksilver/manage-work/projects/create-and-manage-templates/attach-rate-card-to-template.md).

## Adicionar taxas de cobrança entre taxas existentes em um cartão de taxa
...
Anteriormente, só era possível adicionar taxas na parte inferior da lista.

Para obter informações, consulte [Gerenciar cartões de taxa](/help/quicksilver/administration-and-setup/manage-enterprise-operations/manage-rate-cards.md).

## Os atributos de taxa não podem ser editados depois de usados em taxas
