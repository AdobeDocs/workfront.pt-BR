---
title: Sobre o layout padrão do Adobe Workfront
...
O layout padrão é a organização do ![Ícone do menu principal](assets/main-menu-icon-left-nav.png), do painel esquerdo e dos modos de exibição, agrupamentos e filtros antes que um administrador do Adobe Workfront faça alterações usando um modelo de layout.
...
<tbody>
  <tr>
    <td class="tg-0pky">Página inicial</td>
...
### Menu principal padrão para tipos de licença herdados

A tabela a seguir mostra os itens padrão do Menu principal e quais itens do painel esquerdo são exibidos para cada tipo de licença herdado:
...
<tbody>
  <tr>
    <td class="tg-0lax">Página inicial</td>
