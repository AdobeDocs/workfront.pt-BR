...
Você pode instalar o [!DNL Adobe Workfront for XD] do Adobe Marketplace. O plug-in é compatível com os seguintes idiomas:
...
* Você deve instalar o [!DNL Adobe XD] antes de instalar o plug-in do Workfront.

## Instale o [!DNL Adobe Workfront for XD] plug-in da sua organização
...
## Instale o [!DNL Adobe Workfront for XD] plug-in individualmente

Você pode instalar o [!DNL Adobe Workfront for XD] plug-in para si mesmo da [!DNL Adobe Exchange].
...
1. Uma vez [!DNL Adobe XD] gerenciador de plug-in se abre, clique em **[!UICONTROL Instalar]**.
...
## Abra o [!DNL Adobe Workfront for XD] plug-in

1. Aberto [!DNL Adobe XD].

1. Crie um novo arquivo ou abra um existente.

1. No canto inferior esquerdo, clique na guia **Plug-ins** ícone.
...
## Efetue logon no [!DNL Adobe Workfront for XD]
...
1. No navegador, digite o [!DNL Workfront] e clique em **[!DNL Log in]**. Se sua empresa usa um logon único (SSO), você será direcionado à página do seu provedor de SSO para fazer logon.
...
1. Clique em **[!UICONTROL Permitir acesso]** para concluir o logon e voltar para [!DNL Adobe XD] para ver o seu trabalho.
