...
### Adicionar documentos usando o Adobe Cloud Drive

Se sua organização usar o armazenamento em nuvem do Adobe, você também poderá adicionar documentos do seu desktop usando o Adobe Cloud Drive. O Adobe Cloud Drive monta seus projetos de armazenamento em nuvem do Adobe como um drive em seu computador Mac ou Windows. Todos os arquivos salvos em uma pasta de projeto na unidade são sincronizados automaticamente com o Workfront. Para obter mais informações, consulte [visão geral do Adobe Cloud Drive](../../documents/adobe-cloud-drive/adobe-cloud-drive-overview.md).
