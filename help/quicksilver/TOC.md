...
* Anúncios de produtos {#product-announcements}
   ...
   * Versões do produto {#product-releases}
      ...
      * Versão 23.2 {#release-23-2}
         ...
         * [Outros aprimoramentos 23.2](product-announcements/product-releases/23.2-release-activity/23-2-other-enhancements.md)
         * [Look e sentir atualizações durante a versão 23.2 intervalo de tempo](product-announcements/product-releases/23.2-release-activity/23-2-look-and-feel.md)
      * Versão 23.1 {#release-23-1}
         ...
         * [Melhorias 23.1 ágeis](product-announcements/product-releases/23.1-release-activity/23-1-agile-enhancements.md)
      ...
      * Versão 21.4 {#release-21-4}
         ...
         * [Melhorias 21.4 ágeis](product-announcements/product-releases/21.4-release-activity/21-4-agile-enhancements.md)
      ...
      * Arquivamento de versão trimestral {#quarterly-release}
         ...
         * Versão 2018.1 {#release-18-1}
            ...
            * [Versão 4 beta 4 de 2018.1 atividade](product-announcements/product-releases/quarterly-release-archive/2018.1-release-activity/2018-1-beta-4-release-activity.md)
            * [versão final beta 2018.1 atividade](product-announcements/product-releases/quarterly-release-archive/2018.1-release-activity/2018-1-beta-final-release-activity.md)
         * Versão 2017.3 {#release-17-3}
            ...
            * [Versão 2017.3 atividade visão geral](product-announcements/product-releases/quarterly-release-archive/2017.3-release-activity/2017-3-release-activity-overview.md)
         ...
         * Versão 2017.2 {#release-17-2}
            ...
            * [Versão 2017.2 atividade visão geral](product-announcements/product-releases/quarterly-release-archive/2017.2-release-activity/2017-2-release-activity-overview.md)
            * [Versão 1 beta 2017.2 atividade](product-announcements/product-releases/quarterly-release-archive/2017.2-release-activity/2017-2-beta-1-release-activity.md)
            * [Versão 2 beta 2 de 2017.2 atividade](product-announcements/product-releases/quarterly-release-archive/2017.2-release-activity/2017-2-beta-2-release-activity.md)
            * [Versão 3 beta 2017.2 atividade](product-announcements/product-releases/quarterly-release-archive/2017.2-release-activity/2017-2-beta-3-release-activity.md)
         ...
         * Versão Workfront R1 {#r1-release}
            ...
            * [Visão geral atividade da versão R1](product-announcements/product-releases/quarterly-release-archive/r1-release-activity/r1-release-activity-overview.md)
            * [Funcionalidade disponibilizada no Visualização em 2016](product-announcements/product-releases/quarterly-release-archive/r1-release-activity/available-in-preview-in-2016.md)
...
* Administração e configuração {#administration-and-setup}
   ...
   * Personalizar o Adobe Workfront {#customize}
      ...
      * Status e rótulos de prioridade {#statuses-priority-labels}
         ...
         * [Visão geral dos status do projeto do sistema](administration-and-setup/customize-workfront/creating-custom-status-and-priority-labels/system-project-statuses.md)
         ...
         * [Status de problemas de lista](administration-and-setup/customize-workfront/creating-custom-status-and-priority-labels/issue-statuses.md)
         ...
         * [Alterar a solicitar de exibição de status](administration-and-setup/customize-workfront/creating-custom-status-and-priority-labels/reorder-system-statuses.md)
         * [Status de nível de sistema bloqueado e desbloqueado](administration-and-setup/customize-workfront/creating-custom-status-and-priority-labels/lock-or-unlock-a-custom-system-level-status.md)
         * [Tornar os status personalizados padrão](administration-and-setup/customize-workfront/creating-custom-status-and-priority-labels/use-custom-statuses-as-default-statuses.md)
   ...
   * Dicas, truques e solução de problemas para administração e configuração {#admin-setup-tips}
      ...
      * [Lembretes automáticos versus notificações de lembrete](administration-and-setup/tips-tricks-and-troubleshooting/auto-reminders-vs-reminder-notifications.md)
      ...
      * [SAML 2.0: Código de status primário](administration-and-setup/tips-tricks-and-troubleshooting/error-message-saml-2-error-primary-statuscode.md)
      ...
      * [Os campos estão inválido: emailAddr](administration-and-setup/tips-tricks-and-troubleshooting/login-error-following-field-invalid-emailaddr-cant-be-null.md)
      ...
      * [O compartilhamento mostra mais de um permissão](administration-and-setup/tips-tricks-and-troubleshooting/sharing-shows-more-than-1-permission.md)
...
* Noções básicas do Adobe Workfront {#basics}
   ...
   * Dicas, truques e solução de problemas dos conceitos básicos do Adobe Workfront {#tips-tricks-for-basics}
      * [Dicas, truques e solução de problemas para Adobe Systems Workfront: índice de artigo](workfront-basics/tips-tricks-and-troubleshooting/tips-tricks-troubleshooting-basics.md)
      * [Seu guia rápido para encontrar ajuda no Adobe Systems Workfront](workfront-basics/tips-tricks-and-troubleshooting/guide-for-help-in-workfront.md)
      * [Alterar o formato das datas no Adobe Systems Workfront](workfront-basics/tips-tricks-and-troubleshooting/change-date-format-chrome.md)
      * [Entre em contato com o suporte ao cliente](workfront-basics/tips-tricks-and-troubleshooting/contact-customer-support.md)
      * [A comunidade da Adobe Systems workfront](workfront-basics/tips-tricks-and-troubleshooting/workfront-community.md)
...
* Ágil {#agile}
   ...
   * Introdução aos painéis no Adobe Workfront {#boards-in-workfront}
      ...
      * [Demonstrações de vídeo nos Quadros de trabalho](/help/quicksilver/agile/get-started-with-boards/boards-video-demonstrations.md)
      ...
      * [Adicionar documentos nos cartões](/help/quicksilver/agile/get-started-with-boards/add-documents-on-cards.md)
      * [Personalizar quais campos são exibidos em uma cartão](/help/quicksilver/agile/get-started-with-boards/customize-fields-on-card.md)
      * [Excluir ou arquivar um cartão de um quadro](agile/get-started-with-boards/delete-board-items.md)
      * [Filtrar e pesquisa em um quadro](agile/get-started-with-boards/filter-search-in-board.md)
   ...
   * Usar ferramentas de planejamento ágil nos quadros {#agile-planning-boards}
      ...
      * [Gerenciar o limite do trabalho em andamento (WIP) em uma quadro](agile/use-boards-agile-planning-tools/manage-wip-limit-on-board.md)
      ...
      * [Configurar o backlog em uma sequência de trabalho quadro](/help/quicksilver/agile/use-boards-agile-planning-tools/configure-backlog-workstream-board.md)
      * [Revisar métricas de repetição](/help/quicksilver/agile/use-boards-agile-planning-tools/review-iteration-metrics.md)
   * [Visão geral ágil](agile/agile-overview.md)
   * Comece com ágil no Adobe Systems Workfront {#agile-in-workfront}
      * [Comece com ágil no Adobe Systems Workfront](agile/get-started-with-agile-in-workfront/get-started-with-agile.md)
   ...
   * Kanban em uma equipe de ágil {#kanban}
...
* Documentos {#documents}
   ...
   * Gerenciar documentos {#manage-documents}
      ...
      * [Revisor do Workfront AI](/help/quicksilver/review-and-approve-work/document-reviews-and-approvals/wf-ai-reviewer.md)
...
* Gerenciar trabalho {#manage-work}
   ...
   * Projetos {#projects}
      ...
      * Finanças do projeto {#project-finances}
         ...
         * [Definir o método de Index de desempenho (PIM)](manage-work/projects/project-finances/set-pim.md)
         * [Calcular retorno do investimento (ROI)](manage-work/projects/project-finances/calculate-roi.md)
         * [Calcular Index de desempenho de agendamento (SPI)](manage-work/projects/project-finances/calculate-spi.md)
         ...
         * [Calcular Valor líquidos](manage-work/projects/project-finances/calculate-net-value.md)
         * [Calcular Index de desempenho do agendamento de custos (CSI)](manage-work/projects/project-finances/calculate-csi.md)
         * [Calcular Index de desempenho de custo (CPI)](manage-work/projects/project-finances/calculate-cpi.md)
         * [Calcular custo orçado](manage-work/projects/project-finances/budgeted-cost.md)
         * [Calcular o custo orçado do trabalho executado (BCWP)](manage-work/projects/project-finances/calculate-bcwp.md)
   ...
   * Gerenciamento de Portfólio {#portfolio-management}
      ...
      * Criar e gerenciar programas {#create-and-manage-programs}
         ...
         * [programas Editar](manage-work/portfolios/create-and-manage-programs/edit-programs.md)
         * [Adicionar uma programa existente a uma portfólio](manage-work/portfolios/create-and-manage-programs/move-program.md)
      ...
      * Gerenciar projetos no Portfolio Optimizer {#manage-projects-in-portfolio-optimizer}
         ...
         * [Visão geral da pontuação do Portfolio Optimizer](manage-work/portfolios/portfolio-optimizer/portfolio-optimizer-score.md)
         * [Priorizar projetos no Portfolio Optimizer](manage-work/portfolios/portfolio-optimizer/prioritize-projects-in-portfolio-optimizer.md)
         ...
         * [Calcule o risco para Valor líquidos em um portfólio](manage-work/portfolios/portfolio-optimizer/calculate-risk-to-net-value-in-portfolio.md)
   * Solicitações {#requests}
      * [Solicitações](manage-work/requests/requests-overview.md)
      * Filas de solicitação de Criar e gerenciar {#create-and-manage-request-queues}
         ...
         * [Regras de roteamento Criar](manage-work/requests/create-and-manage-request-queues/create-routing-rules.md)
      ...
      * solicitações do Criar {#create-requests}
         * [solicitações do Criar](manage-work/requests/create-requests/create-requests.md)
         ...
         * [Permitir que os usuários enviem um problema por email para um projeto Solicitar fila](manage-work/requests/create-requests/enable-email-issues-into-projects.md)
         * [Localizar solicitações enviadas](manage-work/requests/create-requests/locate-submitted-requests.md)
         * [Compartilhar um link em um solicitação fila](manage-work/requests/create-requests/share-link-to-request-queue.md)
         * [Excluir um rascunho do solicitação](manage-work/requests/create-requests/delete-request-draft.md)
...
* Relatórios {#reporting}
   ...
   * Painéis {#dashboards}
      ...
      * Entender painéis {#understand-dashboards}
         ...
         * [Entenda como os relatórios são exibidos em um painel](reports-and-dashboards/dashboards/understanding-dashboards/understand-how-reports-display-dashboard.md)
      * Criar e gerenciar painéis de controle {#create-dashboards}
         ...
         * [Criar uma painel](reports-and-dashboards/dashboards/creating-and-managing-dashboards/create-dashboard.md)
         ...
         * [Copiar uma painel](reports-and-dashboards/dashboards/creating-and-managing-dashboards/copy-dashboard.md)
         * [Excluir uma painel](reports-and-dashboards/dashboards/creating-and-managing-dashboards/delete-dashboard.md)
         ...
         * [Compartilhar uma painel](reports-and-dashboards/dashboards/creating-and-managing-dashboards/share-dashboard.md)
         * [Remover um Página externo de um painel](reports-and-dashboards/dashboards/creating-and-managing-dashboards/remove-external-page-from-dashboard.md)
   ...
   * Conexão de dados da workfront {#data-lake}
...
* Revisar e aprovar trabalho {#review-and-approve-work}
   ...
   * Revisão e aprovação de ativos e documentos {#document-reviews-and-approvals}
      ...
      * Configurar e gerenciar aprovações de ativos e documentos {#manage-asset-review-and-approval}
         ...
         * [Usar aprovações e provas unificadas juntas](review-and-approve-work/document-reviews-and-approvals/doc-approvals-and-proofing.md)
   ...
   * Prova {#proofing}
      ...
      * Gerenciar provas no Adobe Workfront {#manage-proofs-in-workfront}
         ...
         * Gerenciar provas automáticas {#manage-automated-proofs}
            ...
            * [Converter uma fluxo de Trabalho básica em um fluxo de trabalho automatizado em uma prova](review-and-approve-work/proofing/managing-proofs-within-workfront/convert-basic-automatic-workflow.md)
      ...
      * Usar o visualizador de prova de área de trabalho {#use-the-desktop-proofing-viewer}
         ...
         * [Atualizar o visualizador de prova de desktop](review-and-approve-work/proofing/use-the-desktop-proofing-viewer/update-the-desktop-proofing-viewer.md)
         * [Abrir provas no Visualizador de prova de desktop](review-and-approve-work/proofing/use-the-desktop-proofing-viewer/open-proofs-in-dpv.md)
         * [Analise conteúdo não interativos no Visualizador de provação de desktop](review-and-approve-work/proofing/use-the-desktop-proofing-viewer/review-non-interactive-content-in-desktop-proofing-viewer.md)
      ...
      * Revisar provas no Adobe Systems Workfront {#review-proofs-in-workfront}
...
* Integrações do Adobe Workfront {#adobe-workfront-integrations}
   ...
   * Adobe Workfront para Creative Cloud {#workfront-for-creative-cloud}
      * [Adobe Systems a frente de trabalho para Creative Cloud](workfront-integrations-and-apps/adobe-workfront-for-creative-cloud/wf-adobe-cc.md)
      * Instale o plug-in da Adobe Systems Workfront para aplicativos Creative Cloud {#install-wf-cc}
         * [Instalar Adobe Systems Workfront para aplicativos do Creative Cloud](workfront-integrations-and-apps/adobe-workfront-for-creative-cloud/wf-cc-install-toc.md)
         * [Instale e abra a Adobe Systems Workfront para Photoshop](workfront-integrations-and-apps/adobe-workfront-for-creative-cloud/wf-cc-install-ps.md)
         * [Instale e abra a Adobe Systems Workfront para XD](workfront-integrations-and-apps/adobe-workfront-for-creative-cloud/wf-adobe-xd-install.md)
...
* Prova do Workfront {#workfront-proof}
   ...
   * Administração da conta do Workfront Proof {#wf-proof-account-admin}
      ...
      * Contas satélite no Workfront Proof {#satellite-accounts-in-wf-proof}
         ...
         * [Gerenciar um conta de satélite na Prova de frente de trabalho](workfront-proof/wp-acct-admin/satellite-accounts/manage-sat-acct-in-wp.md)
      * Dicas, truques e solução de problemas para a administração de conta da Prova de trabalho {#ttt-wf-proof-account-admin}
         * [Dicas, truques e solução de problemas para a administração de conta da Prova de trabalho](workfront-proof/wp-acct-admin/tips-tricks-and-troubleshooting/tips-tricks-and-troubleshooting.md)
   ...
   * Configurações de faturamento do Workfront Proof {#wf-proof-billing-settings}
      * [Configurações de faturamento de prova de frente de trabalho](workfront-proof/wp-billingsettings/wp-billing-settings.md)
      * Gerencie suas faturamento {#manage-billing}
         * [Gerencie suas faturamento](workfront-proof/wp-billingsettings/manage-your-billing/manage-your-billing.md)
         * [O Página de faturamento da prova de frente de trabalho](workfront-proof/wp-billingsettings/manage-your-billing/wp-billing-page.md)
         * [Escolha do seu método de pagamento na prova de frente de trabalho](workfront-proof/wp-billingsettings/manage-your-billing/choose-payment-method-in-wp.md)
         * [Baixando sua fatura de prova de workfront](workfront-proof/wp-billingsettings/manage-your-billing/download-wp-invoice.md)
   ...
   * Dispositivos móveis da prova de frente de trabalho {#wf-proof-mobile}
      * [Dispositivos móveis da prova de frente de trabalho](workfront-proof/wp-mobile/wp-mobile.md)
...
* [documento de teste ocultos](hidden-test.md)
