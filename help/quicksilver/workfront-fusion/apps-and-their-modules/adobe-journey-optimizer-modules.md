...
>[!IMPORTANT]
>
>Esse conector foi descontinuado porque era baseado em APIs do Adobe Journey Optimizer que agora estão descontinuadas.
>
>No momento, estamos trabalhando em um novo conector com base na nova API do Adobe Journey Optimizer.
