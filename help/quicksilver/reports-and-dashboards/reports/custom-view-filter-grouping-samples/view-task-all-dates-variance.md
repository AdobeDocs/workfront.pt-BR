...
title: '"Exibir: tarefa com variação Todas as datas'''
description: Essa exibição de tarefa é semelhante à exibição "Todas as datas" fornecida com sua conta Adobe Workfront. Essa exibição específica inclui colunas Variance , que calculam a diferença em dias entre as datas a seguir - EDIT ME.
...
# Exibir: tarefa com variação Todas as datas

Essa exibição de tarefa é semelhante à exibição &quot;Todas as datas&quot; fornecida com sua conta Adobe Workfront. Essa exibição específica inclui *Variação* colunas, que calculam a diferença em dias entre as seguintes datas:

* Datas de Início Planejadas e Projetadas
* Datas de Início Planejadas e Reais
* Datas de conclusão planejadas e projetadas
* Datas de Conclusão Planejadas e Reais

Essa exibição representa um exemplo de colunas calculadas, em que é possível obter os valores de duas colunas diferentes e conectá-los por um cálculo para obter um terceiro valor. Nesse caso, subtraia a data 1 da data 2.

Para obter mais informações sobre como usar cálculos em uma Exibição, consulte a [Visão geral dos usos comuns do modo de texto](../../../reports-and-dashboards/reports/text-mode/understand-common-uses-text-mode.md) seção em  [Visão geral dos usos comuns do modo de texto](../../../reports-and-dashboards/reports/text-mode/understand-common-uses-text-mode.md).
...
## Exibir tarefas com a variação Todas as datas
