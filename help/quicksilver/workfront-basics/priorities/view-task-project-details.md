...
# Visualizar detalhes do projeto e do item de trabalho em Prioridades
...
1. Clique em **Projeto** na parte superior do painel Resumo. Aqui você pode:
   ...
   * Ir diretamente para o projeto
   ...
   ![detalhes do projeto](assets/project-details-060226.png)
...
1. Tarefa é selecionada por padrão. Aqui você pode:
   ...
   * Adicionar links rápidos
   ...
   ![detalhes da tarefa](assets/task-details-060226.png)
...
1. Problema é selecionado por padrão. Aqui você pode:
   ...
   * Criar uma prova
   ...
   ![detalhes do problema](assets/issue-details-060226.png)
