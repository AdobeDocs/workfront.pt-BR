...
<span class="preview">O gerenciamento da exibição de tabela é diferente, dependendo do ambiente do qual você a acessa. </span>

## Gerenciar a exibição de tabela no ambiente de Produção
...
Adicionar filtros na exibição de tabela no ambiente de Pré-visualização é idêntico a adicionar filtros no ambiente de Produção.

Para obter informações, consulte a seção [Adicionar filtros](#add-filters) neste artigo.
...
A ativação do indicador de presença em tempo real na exibição de tabela no ambiente de Pré-visualização é idêntica à ativação no ambiente de Produção.

Para obter informações, consulte a seção [Habilitar o indicador de presença em tempo real](#enable-the-real-time-presence-indicator) neste artigo.
