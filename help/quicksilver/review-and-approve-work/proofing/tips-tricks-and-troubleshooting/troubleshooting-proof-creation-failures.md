...
* O arquivo está protegido por uma senha ou o conteúdo de cópia está desabilitado.
  ...
  Diferentemente de outros tipos de arquivos, os arquivos PDF podem ser gerados em provas se a configuração de segurança para cópia de conteúdo estiver definida como Permitido na PDF.
