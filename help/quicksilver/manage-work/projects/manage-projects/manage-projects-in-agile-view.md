...
# Gerenciar um projeto ágil na visualização de quadro
...
Para obter informações, consulte [Trabalhar em um ambiente Agile](../../../agile/work-in-an-agile-environment/work-in-an-agile-environment.md).
