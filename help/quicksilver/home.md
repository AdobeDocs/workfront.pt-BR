...
* [Visão geral da versão do quarto trimestre de 2026](/help/quicksilver/product-announcements/product-releases/26-q4-release-activity/26-q4-release-overview.md)
* [Atividade de lançamento do Planejamento do Adobe Workfront](/help/quicksilver/product-announcements/product-releases/planning-release-activity/planning-release-activity-26-q4.md)
* [Atividade de versões do Adobe Workfront Fusion](https://experienceleague.adobe.com/pt-br/docs/workfront-fusion/using/fusion-release-activity/fusion-release-activity)

>[!TAB Versões de 2026]

* [Visão geral da versão do quarto trimestre de 2026](/help/quicksilver/product-announcements/product-releases/26-q4-release-activity/26-q4-release-overview.md)
* [Visão geral da versão do terceiro trimestre de 2026](/help/quicksilver/product-announcements/product-releases/26-q3-release-activity/26-q3-release-overview.md)
...
* [Atividade de lançamento do Planejamento do Adobe Workfront](/help/quicksilver/product-announcements/product-releases/planning-release-activity/planning-release-activity-article-index.md)
...
* [Atividade de lançamento do Planejamento do Adobe Workfront](/help/quicksilver/product-announcements/product-releases/planning-release-activity/planning-release-activity-article-index.md)
* [Atividade de lançamento do Adobe Workfront Fusion](/help/quicksilver/product-announcements/product-releases/planning-release-activity/planning-release-activity-article-index.md)
...
* [Programas Beta](/help/quicksilver/product-announcements/betas/betas.md)
...
* [Atualizações de manutenção do](https://experienceleague.adobe.com/pt-br/docs/workfront-known-issues/releases/current-updates)
...
<tr>
  ...
  <tr>
    <td>
    <ul>
    <li><a href="/help/quicksilver/administration-and-setup/get-started-wf-administration/get-started-with-wf-administration.md">Começar a usar a administração do Workfront</a></li>
    ...
    <li><a href="/help/quicksilver/app-builder/install-apps-on-exchange.md">Adquirir e instalar aplicativos do Adobe Exchange</a></li>
    </ul>
 </td>
    <td>
        <ul>
        <li><a href="/help/quicksilver/workfront-basics/workfront-basics.md">Noções básicas do Adobe Workfront: índice de artigos</a></li>
        <li><a href="/help/quicksilver/manage-work/manage-work.md">Introdução ao gerenciamento do trabalho</a></li>
        <li><a href="/help/quicksilver/reports-and-dashboards/reports-and-dashboards-overview.md">Introdução aos relatórios e painéis</a></li>
        <li><a href="/help/quicksilver/reports-and-dashboards/reports/text-mode/text-mode-resources.md">Introdução ao modo Texto</a></li>
        </ul>
    </td>
    <td><ul>
        <li><a href="/help/quicksilver/agile/agile-overview.md">Introdução ao Ágil</a></li>
        <li><a href="/help/quicksilver/documents/documents-overview.md">Introdução aos documentos</a></li>
        <li><a href="/help/quicksilver/resource-mgmt/workload-balancer/workload-balancer.md">Introdução ao Workload Balancer</a></li>
...
## Dicas para encontrar conteúdo na Experience League

A pesquisa de documentação pode ser mais eficiente com algumas abordagens estratégicas. Veja a seguir algumas dicas que podem ajudar você a encontrar o que precisa com eficácia:

### Use o sumário e a barra de pesquisa

* **Índice**: comece pelo índice para obter uma visão geral dos tópicos disponíveis e refine sua pesquisa por tópicos específicos expandindo as seções.
* **Barra de pesquisa**: use a barra de pesquisa para encontrar documentação. Insira termos específicos relacionados ao problema ou tópico. Em vez de termos gerais como “gerenciamento de projetos”, use “configuração da linha do tempo do projeto” ou “dependências de tarefas”.
