...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td scope="col"> <p>O total de horas orçadas nos projetos incluídos. Você pode exibir o total de horas orçadas para a vida geral dos projetos incluídos, ou pode exibir o total de horas orçadas somente para o intervalo de datas especificado (você pode especificar uma semana ou mês individual). </p> <p>As horas orçadas são preenchidas com base nas informações disponíveis na área Orçamento de recursos do Business Case ou do Planejador de recursos<em>.</em></p> <p>As Horas Orçadas são exibidas no relatório de Utilização em qualquer uma das seguintes linhas:</p> 
    <ul> 
    ...
    </ul> <p>Para obter mais informações sobre horas orçadas, consulte <a href="/help/quicksilver/manage-work/projects/project-finances/budgeted-labor-cost.md#locate-the-budgeted-hours-of-a-project">Localizar as horas orçadas de um projeto</a> in <a href="/help/quicksilver/manage-work/projects/project-finances/budgeted-labor-cost.md">Entender o custo do trabalho orçado e as horas orçadas dos projetos</a>.</p> </td> 
  </tr> 
  <tr> 
...
<li><strong>Horas não alocadas</strong>: as Horas Planejadas são exibidas no relatório de utilização na seção Horas Não Alocadas quando as Horas Planejadas são associadas a uma tarefa ou problema e não há usuário ou função atribuída à tarefa ou problema. Essa seção aparece somente quando há horas no projeto que correspondem a essa descrição e ao exibir o relatório de Utilização de um único projeto. <br>Para obter mais informações sobre as horas planejadas, consulte <a href="../../manage-work/tasks/task-information/planned-hours.md">Visão geral das Horas planejadas</a>.
  ...
  <tr> 
   ...
   <td> <p> O total de horas registradas nas tarefas, problemas, <span>e no projeto</span> para os projetos incluídos. Você pode exibir o total de horas reais para a vida geral dos projetos incluídos, ou pode exibir o total de horas reais somente para o intervalo de datas especificado (você pode especificar uma semana ou mês individual). </p> <p><strong>Aviso:</strong> O relatório de utilização inclui horas registradas no projeto, tarefas secundárias, problemas e tarefas principais que tenham pelo menos uma atribuição. Não inclui horas registradas em tarefas pai sem atribuições. Recomendamos que você não use tarefas pai como tarefas de trabalho e atribua somente tarefas filho aos seus recursos. </p> <p>As Horas Reais são exibidas no relatório de utilização em qualquer uma das seguintes linhas:</p> 
    <ul> 
...
Para obter informações sobre os campos específicos e como o Workfront os calcula, consulte também [Rastrear custos](../../manage-work/projects/project-finances/track-costs.md) e [Visão geral de faturamento e receita](../../manage-work/projects/project-finances/billing-and-revenue-overview.md).
...
Se você tiver uma tarefa de Receita Fixa e não houver Horas Reais na tarefa, a Receita Real não será exibida no Relatório de Utilização porque não há como distribuir horas. </p> <p><strong>Função por hora:</strong> A receita na tarefa é calculada usando a taxa de cobrança definida para uma função específica, multiplicada pelo número de Horas Efetivas.</p> <p>O Workfront usa a seguinte fórmula:</p> <p><code>Receita Real Horária da Função = SUM(Horas Reais da função em todas as tarefas) * Taxa de Faturamento da Função</code> </p> <p><b>NOTA:</b> A taxa horária de faturamento na fórmula considera quaisquer alterações de data de efetivação da taxa.</p> <p><strong>Hora do usuário:</strong> A receita na tarefa é calculada usando a taxa de faturamento definida para um usuário específico, multiplicada pelo número de horas registradas na tarefa desse usuário. O Workfront usa a seguinte fórmula:</p> <p><code>Receita Real Horária do Usuário = SUM(Horas Reais do usuário em todas as tarefas) * Taxa de Faturamento do Usuário</code></p> <p><b>NOTA:</b> A taxa horária de faturamento na fórmula considera quaisquer alterações de data de efetivação da taxa.</p> <p><b>Horas por Valor da Hora do Perfil mais Taxa Fixa</b> </p> <p><b>IMPORTANTE</b>
...
Se a Receita planejada for igual a 0, a Margem será exibida como 0. </p> </td>
  ...
  <tr> 
   <td scope="col"><strong>Receita Efetiva</strong> </td> 
...
1. Desempenhe uma das ações a seguir, dependendo se você está exibindo informações de utilização de um projeto individual, de vários projetos, de um programa ou de um portfólio:
   ...
   * Para exibir as informações de utilização de um único projeto:
      ...
      1. As informações de utilização são exibidas automaticamente ao visualizar um projeto individual, e a aplicação de um filtro não é necessária.\
         ...
         Para obter informações sobre como filtrar o relatório de Utilização, consulte [Filtrar informações de utilização](#filter-utilization-information) neste artigo.\
...
Você deve especificar um ou mais projetos no filtro antes de executar o relatório de Utilização. Para obter informações sobre como filtrar o relatório de Utilização, consulte [Filtrar informações de utilização](#filter-utilization-information) neste artigo.\
   ...
   * Para exibir as informações de utilização de um programa:
     ...
     {{step1-to-utilization-report}}
      ...
      1. Aplique um filtro ao relatório de Utilização e clique em **Executar**.\
         Você deve especificar um ou mais programas no filtro antes de executar o relatório de Utilização. Para obter informações sobre como filtrar o relatório de Utilização, consulte [Filtrar informações de utilização](#filter-utilization-information) neste artigo.\
   ...
   * Para exibir informações sobre utilização de um portfólio:
     ...
     {{step1-to-utilization-report}}
      ...
      1. Aplique um filtro ao relatório de Utilização e clique em **Executar**.\
         Você deve especificar um ou mais portfólios no filtro antes de executar o relatório de Utilização. Para obter informações sobre como filtrar o relatório de Utilização, consulte [Filtrar informações de utilização](#filter-utilization-information) neste artigo.\
...
1. No canto superior direito do relatório de Utilização, clique em **Exibir**, em seguida, selecione um dos seguintes no menu:
...
Consulte [Acompanhe o progresso, o custo e a receita com o relatório de Utilização](#track-progress-cost-and-revenue-with-the-utilization-report) para fazer isso.
...
1. Especifique as seguintes informações para criar ou modificar o filtro:
   ...
   * **Portfolio:** Comece digitando o nome do portfólio que contém as informações que você deseja incluir no relatório de Utilização e, em seguida, clique no nome quando ele aparecer na lista suspensa\
   ...
   * **Programas:** Comece digitando o nome do programa que contém as informações que você deseja incluir no relatório de Utilização e, em seguida, clique no nome quando ele aparecer na lista suspensa.\
   ...
   * **Projetos:** Comece digitando o nome do projeto que contém as informações que você deseja incluir no relatório de Utilização e, em seguida, clique no nome quando ele aparecer na lista suspensa.\
   ...
   * **Tarefas:** Comece digitando o nome da tarefa que contém as informações que você deseja incluir no relatório de Utilização e, em seguida, clique no nome quando ele aparecer na lista suspensa.\
     Repita esse processo para incluir informações de várias tarefas no relatório de Utilização.\
   ...
   * **Problemas:** Comece digitando o nome da ocorrência que contém as informações que você deseja incluir no relatório de Utilização e, em seguida, clique no nome quando ele aparecer na lista suspensa.\
     ...
     As informações de custo para problemas nem sempre são incluídas no relatório de Utilização. Para obter mais informações sobre quando as informações de custo para ocorrências são incluídas no relatório de Utilização, consulte [Acompanhe o progresso, o custo e a receita com o relatório de Utilização](#track-progress-cost-and-revenue-with-the-utilization-report) neste artigo.

   * **Funções:** Comece digitando o nome da função que deseja ser representada no Relatório de Utilização e, em seguida, clique no nome quando ele for exibido na lista suspensa. Repita esse processo para incluir funções adicionais.
O Relatório de Utilização contém informações apenas para as funções especificadas. Por exemplo, uma tarefa contém 10 Horas Reais. Seis dessas horas são de uma função de Designer e quatro são de uma função de Desenvolvedor. Se você filtrar o Relatório de Utilização por função para Designer, as quatro horas provenientes da função Desenvolvedor serão excluídas do relatório.

   * **Adicionar Regra de Filtro:** Clique em **Adicionar Regra de Filtro**, clique no campo de texto e comece a digitar o nome do campo que deseja filtrar. Se o campo estiver disponível, ele será preenchido para cada objeto em que puder ser associado. Clique no nome do campo para adicioná-lo ao filtro.
...
1. Para criar um novo filtro, clique **Salvar Filtro**.\
   Ou\
   Para modificar um filtro existente, clique na seta ao lado da tag **Salvar Filtro** e clique em **Salvar novo filtro**.
No **Nome do filtro** digite um nome para o filtro e clique em **Salvar**.
...
1. Clique em **Filtros salvos** e, em seguida, selecione o filtro que deseja aplicar na lista suspensa.
...
1. Clique em **Filtros salvos**, passe o mouse sobre o filtro que deseja duplicar e clique em **Duplicar** ícone.

   ![Ícone Duplicar](assets/utilization-filter-duplicate.png)

   A caixa de diálogo Duplicar Filtro é exibida.

1. No **Nome do filtro** digite um nome para o novo filtro e clique em **Salvar**.
...
1. Clique em **Filtros salvos**, passe o mouse sobre o filtro que deseja renomear e clique em **Renomear** ícone.
...
1. Clique em **Filtros salvos**, passe o mouse sobre o filtro que deseja excluir e clique no botão **Excluir** ícone.
...
1. Escolha entre as seguintes opções:
   ...
   * **Mês:** Selecione essa opção para selecionar um determinado mês.
   ...
   O intervalo de datas selecionado é exibido no relatório de Utilização, à esquerda do **Geral** coluna.\
...
1. Clique em **Exportar** na parte superior esquerda do relatório.
...
1. No canto superior direito do relatório de Utilização, clique no **Gráfico** ícone.
   ...
   ![Ícone do gráfico](assets/utilization-chart.png)

   O relatório de Utilização é exibido em uma exibição de gráfico.

1. (Opcional) Configure o gráfico para mostrar Projetos, Programas ou Portfolio selecionando a opção apropriada no **Mostrar** menu suspenso.
...
1. (Opcional) Ajuste os filtros para alterar quais informações são exibidas no gráfico. Para obter informações sobre como ajustar os filtros, consulte [Filtrar informações de utilização](#filter-utilization-information) neste artigo.
1. (Opcional) Configure o intervalo de tempo do relatório do gráfico, conforme descrito em [Ajustar o intervalo de datas para o qual as informações são exibidas](#adjust-the-date-range-for-which-information-is-displayed) neste artigo.
