...
title: Atividade de lançamento da versão 2018.2 Beta 2
...
# Atividade de lançamento da versão 2018.2 Beta 2
...
* [Use o Custo Orçado no Portfolio Otimizer para Calcular as Finanças da Portfolio](#use-budgeted-cost-in-the-portfolio-optimizer-to-calculate-portfolio-finances)
...
Para obter mais informações, consulte o [Atualizar ou editar um item de trabalho na área Página Inicial](../../../../workfront-basics/using-home/using-the-home-area/update-and-edit-work-item-home.md) no artigo [Atualizar ou editar um item de trabalho na área Página Inicial](../../../../workfront-basics/using-home/using-the-home-area/update-and-edit-work-item-home.md).
...
## Use o Custo orçado no Portfolio Otimizer para calcular as finanças do Portfolio {#use-budgeted-cost-in-the-portfolio-optimizer-to-calculate-portfolio-finances}

O novo Portfolio Otimizer agora usa o Custo Orçado da nova área Orçamento de Recursos do Business Case ou do Planejador de Recursos para calcular os seguintes campos:

* Valor líquido
* Retorno sobre o investimento (ROI)
* Custo

Anteriormente, o Portfolio Otimizer novo e herdado usava o Custo orçado herdado. O Portfolio Otimizer herdado ainda usa o Custo orçado herdado para calcular o Valor líquido, o Retorno sobre o investimento e o Custo.

Também adicionamos dois novos campos aos Campos financeiros do Portfolio: ROI herdado e Valor líquido herdado para capturar os novos valores das novas ferramentas de gerenciamento de recursos.
