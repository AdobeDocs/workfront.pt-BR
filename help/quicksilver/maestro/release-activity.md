...
Para obter informações, consulte [Gerenciar registros na seção Planning de objetos do Adobe Workfront](/help/quicksilver/maestro/records/manage-records-in-planning-section.md).
...
Para obter informações, consulte [Gerenciar a página de registros](/help/quicksilver/maestro/records/manage-the-record-page.md).
...
Para obter mais informações, consulte [Editar campos](/help/quicksilver/maestro/fields/edit-fields.md).
...
Para obter informações, consulte [Criar tipos de registro](/help/quicksilver/maestro/architecture/create-record-types.md).
...
Para obter mais informações sobre notificações de planejamento do Workfront, consulte [Notificações do Adobe Workfront Planning: índice do artigo](/help/quicksilver/maestro/notifications/notifications-information.md).
