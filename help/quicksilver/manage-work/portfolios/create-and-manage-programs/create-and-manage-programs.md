...
description: Os programas representam uma coleção de projetos que compartilham uma estratégia, objetivo ou meta comum que transcende os limites do projeto. Programas não podem existir fora de um portfólio.
author: Alina
...
Os programas representam uma coleção de projetos que compartilham uma estratégia, objetivo ou meta comum que transcende os limites do projeto. Programas não podem existir fora de um portfólio.
