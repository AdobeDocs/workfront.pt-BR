...
Essa exibição de tarefa é semelhante à exibição &quot;Todas as datas&quot; fornecida com sua conta da Adobe Workfront. Essa visualização específica inclui *Variação* colunas, que calculam a diferença em dias entre as seguintes datas:
...
Para obter mais informações sobre o uso de cálculos em uma Exibição, consulte [Visão geral de usos comuns do modo de texto](../../../reports-and-dashboards/reports/text-mode/understand-common-uses-text-mode.md) seção em  [Visão geral de usos comuns do modo de texto](../../../reports-and-dashboards/reports/text-mode/understand-common-uses-text-mode.md).
