...
- Remover blocos **apenas para visualização** (extensões/divisões ou parágrafos que explicam apenas que o conteúdo realçado é somente para visualização, versão rápida, sandbox etc.) assim que o recurso for GA.
