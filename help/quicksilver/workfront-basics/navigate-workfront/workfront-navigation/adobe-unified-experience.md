...
Para obter informações sobre como fazer logon no Workfront na Adobe Unified Experience, consulte [Fazer logon no Adobe CX Enterprise](#log-in-to-adobe-cx-enterprise) neste artigo.
...
## Faça logon no [!DNL Adobe CX Enterprise]
...
1. Na tela [!UICONTROL **Entrar**], digite seu endereço de email e clique em **[!UICONTROL Continuar]**.
   ...
   ![Entrar no [!DNL Adobe CX Enterprise]](assets/aec-login-page.png)
...
Depois de fazer logon no [!DNL Adobe CX Enterprise], você poderá exibir todas as organizações e ambientes do [!DNL Workfront] aos quais tem acesso clicando no alternador de organização na área de navegação superior. Selecione a organização ou o ambiente [!DNL Workfront] em que você deseja trabalhar. Os ambientes podem incluir [!UICONTROL Visualização] e [!UICONTROL Sandbox] se sua organização os utilizar.

![Exibir [!DNL Workfront] organizações e ambientes](assets/wf-org-instance-switcher-2026.png)

>[!NOTE]
>
>Na primeira vez que você fizer logon no [!DNL Adobe CX Enterprise], a organização assumirá como padrão o primeiro item na lista alfabética. Na próxima vez que você fizer logon, a organização assumirá como padrão a última que você visitou.

[!DNL Workfront] aparece na lista de [!DNL Adobe CX Enterprise] produtos aos quais você tem acesso. Você pode escolher [!DNL Workfront] no menu de acesso rápido da home page do [!DNL CX Enterprise] ou usar o alternador de produto ![alternador de produto](assets/main-menu-icon.png) para alterar os aplicativos a qualquer momento.
...
![Menu Perfil](assets/unified-shell-profile-menu-2026.png)

Esse menu permite:

* Escolha a formatação do **[!UICONTROL Tema escuro]** para [!DNL Adobe CX Enterprise].
* Definir **[!UICONTROL Preferências]** para [!DNL Adobe CX Enterprise], incluindo as preferências de idioma principal e secundário.

  >[!NOTE]
  >
  >As configurações de data se baseiam nas configurações de idioma principal. Por exemplo, selecionar **Inglês (Estados Unidos)** exibe as datas no formato MM/DD/AAAA, enquanto selecionar **Inglês (Reino Unido)** exibe as datas no formato DD/MM/AAAA.
...
* **[!UICONTROL Sair]** de [!DNL Adobe CX Enterprise].
