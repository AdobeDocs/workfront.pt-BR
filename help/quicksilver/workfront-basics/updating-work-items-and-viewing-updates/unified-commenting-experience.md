...
description: A nova experiência de comentários unificados
author: Nolan
...
Para obter informações sobre quais objetos incluem a seção Atualizações, consulte [Visão geral da guia Atualizações](../../workfront-basics/updating-work-items-and-viewing-updates/updates-tab-overview.md).

Embora atualmente seja implementada apenas no Adobe Workfont Goals, essa nova experiência acabará por unificar os comentários no Adobe Workfront e além, em toda a Adobe Experience Cloud.
...
>[!IMPORTANT]
>Os recursos da Experiência de comentário unificada listados abaixo estão disponíveis no momento apenas no Adobe Workfront Goals.
...
* **Resposta a comentários**
   ...
   Você pode reagir a um comentário com uma curtida ou responder com um novo comentário no thread que pode notificar o comentarista original e o proprietário do objeto.
