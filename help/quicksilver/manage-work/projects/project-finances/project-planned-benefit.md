...
O benefício planejado não é calculado pela Adobe Workfront. Como Proprietário do Projeto, você especifica manualmente o Benefício Planejado de um projeto ao editá-lo. Recomendamos que cada organização estabeleça uma política sobre como esse valor é determinado.
...
* No Resumo de Business Case. Não é possível editar o Benefício Planejado de um projeto no Resumo de Business Case.
...
* Em um relatório de projeto, ao adicionar a coluna Benefício Planejado à exibição do relatório. Você pode editar o Benefício planejado de um projeto em um relatório de projeto.\
...
* No Portfolio Otimizer. Não é possível editar o Benefício planejado de um projeto no Portfolio Otimizer.\
...
1. Clique em **Detalhes do Projeto** no painel esquerdo ou clique no ícone **Mais** ![](assets/qs-more-icon-on-an-object.png) à direita do nome do projeto e clique em **Editar**.
1. Especifique o valor do benefício planejado no campo **Benefício Planejado**.
1. (Condicional) Dependendo da área do projeto selecionado, clique em **Salvar alterações** ou **Salvar**.
