...
Você pode usar o [!DNL Adobe Workfront] for [!DNL Salesforce] para integrar os sistemas [!DNL Salesforce] e [!DNL Workfront]. Os artigos desta seção descrevem como instalar, configurar e usar o [!DNL Workfront] for Salesforce.

* [Visão geral das [!DNL Adobe Workfront for Salesforce]](../../workfront-integrations-and-apps/using-workfront-with-salesforce/workfront-for-salesforce-overview.md)
