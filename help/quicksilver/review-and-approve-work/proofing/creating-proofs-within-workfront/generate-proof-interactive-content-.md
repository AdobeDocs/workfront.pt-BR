...
title: Criar uma prova para o conteúdo interativo em um arquivo ZIP
description: Você pode gerar uma prova para o conteúdo interativo de fora do site armazenado em um arquivo ZIP. Exemplos desse tipo de conteúdo da Web incluem anúncios com streaming de vídeo ou áudio, animações de HTML, banners interativos.
author: Courtney
...
# Criar uma prova para o conteúdo interativo em um arquivo ZIP

Você pode gerar uma prova para o conteúdo interativo de fora do site armazenado em um arquivo ZIP. Exemplos desse tipo de conteúdo da Web incluem anúncios com streaming de vídeo ou áudio, animações de HTML, banners interativos.
...
Depois de adicionar conteúdo interativo em um arquivo ZIP a uma prova, o Adobe Workfront cria uma prova dos documentos compactados. Dependendo do tamanho do arquivo, o tempo de carregamento pode variar. Arquivos maiores levam mais tempo para serem criados. Você pode sair da página e o Workfront continua a criar seu arquivo. O tamanho máximo de upload de arquivo é de 4 GB. 

1. Prepare seu conteúdo criando um arquivo compactado ZIP.
   ...
   * Verifique se o arquivo principal (como index.html, index.htm) está na pasta raiz e se é o único arquivo .html/.htm armazenado lá.
      ...
      Se o arquivo principal não for colocado na pasta raiz, o Workfront pesquisará na pasta para localizar o arquivo principal.
...
1. Vá para o projeto, tarefa ou problema onde deseja fazer upload do arquivo ZIP.
