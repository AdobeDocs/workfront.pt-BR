...
1. Na barra na parte inferior da tela, clique em **Enviar para**.

1. Escolha a integração do Experience Manager que seu administrador configurou e clique em **Enviar**.
