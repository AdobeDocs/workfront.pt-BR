...
title: Criar cenários com  [!DNL Adobe Workfront Fusion]  modelos
...
# Criar cenários com [!DNL Adobe Workfront Fusion] modelos

[!DNL Adobe Workfront Fusion] Modelos permitem criar e usar modelos existentes como ponto de partida para seus cenários [!DNL Workfront Fusion].
...
1. Clique no ícone **[!UICONTROL Modelos]** no painel de navegação esquerdo.![](assets/fusion-template-icon.png)
1. Clique na guia que contém o modelo que você deseja usar (**[!UICONTROL Modelos públicos]** ou **[!UICONTROL Modelos de equipe]**).
1. Clique no template que deseja usar para começar a criar um cenário. Você pode usar o recurso de pesquisa para localizar o modelo pelo seu nome ou pelo nome do aplicativo incluído nele.
...
1. Ao definir todas as configurações necessárias para o modelo, você recebe uma notificação de que o modelo está pronto para ser usado e as opções de cenário padrão são exibidas na parte inferior da tela. Agora você pode continuar criando seu cenário.
   ...
   Para obter informações sobre como criar um cenário, consulte [Criar um cenário [!DNL Adobe Workfront Fusion]](../../../workfront-fusion/scenarios/create-a-scenario.md).

1. Clique no ícone **[!UICONTROL Salvar]** ![](assets/save-icon.png) para salvar seu cenário. O cenário é salvo na área Cenário do Workfront Fusion.
