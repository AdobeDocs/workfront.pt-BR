...
A edição de tarefas de modelo difere, dependendo de qual ambiente você escolhe para editar as tarefas.

### Editar tarefas de modelo no ambiente de Produção

>[!NOTE]
>
><span class="preview">Alguns clientes podem editar tarefas de modelo em seus ambientes de Produção da mesma maneira que o fazem no ambiente de Pré-visualização.</span>
>
><span class="preview">Para obter informações sobre como editar tarefas no ambiente de Visualização, consulte a seção [Editar tarefas de modelo no ambiente de Visualização](#edit-template-tasks-in-the-preview-environment) neste artigo. </span>
...
### Editar tarefas de modelo no ambiente de Pré-visualização
...
* [Nome do modelo de tarefa](#template-task-name)
* [Visão geral](#overview-2)
* [Atribuições](#assignments-2)
* [Finanças](#finance-2)
