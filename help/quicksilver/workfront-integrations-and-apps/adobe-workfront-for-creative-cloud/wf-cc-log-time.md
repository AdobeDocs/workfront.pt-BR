...
title: Registrar tempo usando o plugin do Adobe Workfront
...
TQID: https://experienceleague.adobe.com/pheU7UDpbsobLFFEU3BtW6llMCVUdH4lasMNwDczPNg
product_v2:
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>[!UICONTROL Editar] acesso a tarefas ou problemas</p></td> 
  </tr> 
  <tr> 
   <td role="rowheader">Permissões de objeto</td> 
   <td> <p>Permissão [!UICONTROL Log Hours] para a tarefa ou problema</p> </td> 
  </tr> 
 </tbody> 
</table>
...
## Registrar tempo usando o plugin do Adobe Workfront
