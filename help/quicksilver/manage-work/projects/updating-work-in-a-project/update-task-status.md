...
TQID: https://experienceleague.adobe.com/9Tg6QgliblYWDwByNRX0BPylwP4u6lHXMwAUFwes7Rw
...
1. Para fornecer uma indicação visual da conclusão da tarefa, arraste a bolha para abaixo de **Percentual concluído** no cabeçalho da tarefa.
   ...
   ![Cabeçalho da tarefa de widgets de status de porcentagem concluída](assets/percent-complete-status-widgets-task-header.png)
