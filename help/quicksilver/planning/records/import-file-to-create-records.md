...
<p>Para obter mais informações, consulte <a href="/help/quicksilver/workfront-basics/navigate-workfront/workfront-navigation/adobe-unified-experience.md">Experiência unificada da Adobe para Workfront</a>. </p> 
  ...
  <tr> 
   ...
   <p>Edite o acesso no Workfront para os tipos de objeto que deseja criar (projetos, programas e portfólios) à medida que os conecta a partir de novos registros  </p>  
</td> 
  </tr> 
<tr> 
...
* Os campos dos seguintes tipos não são suportados e não podem ser mapeados para campos na planilha de importação:
   ...
   * <span class="preview">Data de Aprovação, Aprovado por</span>
   * Pessoas
