...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <td><strong>Disponível nestas datas:</strong> <p>Versão de pré-visualização do Beta: 2 de julho de 2020</p> <p>Versão de produção: com a versão 20.3</p> <p><strong>Disponível nestes ambientes:</strong> </p> <p>A nova experiência do Adobe Workfront </p> <p>Adobe Workfront Classic </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   ...
   <td> <p><strong>Disponível nestas datas:</strong> </p> <p>Versão de pré-visualização do Beta: 2 de julho de 2020</p> <p>Versão de produção: com a versão 20.3</p> <p><strong>Disponível nestes ambientes:</strong> </p> <p>A nova experiência do Adobe Workfront </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/20.3-release-activity/20-3-project-management-enhancements.md#set" class="MCXref xref">Para administradores: definir preferências de projeto no nível de grupo</a> </p> <p>Para dar mais autonomia aos administradores de grupo e permitir maior personalização dos fluxos de trabalho no nível do grupo, agora é possível definir as preferências do projeto no nível do grupo, para os grupos que você administra. Ao criar um projeto, as preferências do grupo entrarão em vigor antes das preferências do sistema.</p> </td> 
   <td> <p><strong>Disponível nestas datas:</strong> </p> <p>Versão de visualização do Beta: 10 de julho de 2020</p> <p>Versão de produção: com a versão 20.3 <strong> (temporariamente indisponível para a maioria dos clientes nos clusters 1, 2, 3 e 5)</strong></p> <p><strong>Disponível nestes ambientes:</strong> </p> <p>A nova experiência do Adobe Workfront </p> <p>Adobe Workfront Classic </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/20.3-release-activity/20-3-other-enhancements.md#group" class="MCXref xref">Administradores de Grupos podem criar e gerenciar processos de aprovação</a> </p> <p>Para permitir mais autonomia e controle dos fluxos de trabalho de seus grupos, um Administrador de grupo agora pode acessar a área Processo de aprovação em Configurar, criar e editar processos de aprovação para um grupo gerenciado por ele. Esses processos de aprovação se baseiam nos status desse grupo.</p> </td> 
  ...
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/20.3-release-activity/20-3-other-enhancements.md#new2" class="MCXref xref">Novo para administradores: Brand Workfront para grupos, equipes, funções de trabalho e usuários específicos</a> </p> <p>Agora é possível usar um Modelo de layout para alterar os logotipos na área de navegação superior e no Menu principal para grupos, equipes, funções de trabalho e usuários específicos que têm sua própria marca.</p> </td> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <td><strong>Disponível nestas datas:</strong> <p>Versão de pré-visualização do Beta: 19 de junho de 2020</p> <p>Versão de produção: com a versão 20.3</p> <p><strong>Disponível nestes ambientes:</strong> </p> <p>A nova experiência do Adobe Workfront </p> <p>Adobe Workfront Classic </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/20.3-release-activity/20-3-agile-enhancements.md#agile" class="MCXref xref">Quadros Agile carregam 50 itens de trabalho de cada vez</a> </p> <p>Para aumentar a velocidade e o desempenho das ferramentas Agile, agora são carregadas até 50 placas em vários locais. Se houver mais de 50 itens de trabalho em um quadro Agile, um botão será exibido na parte inferior do quadro ou backlog, permitindo carregar itens de trabalho adicionais.</p> </td> 
   <td><strong>Disponível nestas datas:</strong> <p>Versão de pré-visualização do Beta: 19 de junho de 2020</p> <p>Versão de produção: com a versão 20.3</p> <p><strong>Disponível nestes ambientes:</strong> </p> <p>A nova experiência do Adobe Workfront </p> <p>Adobe Workfront Classic </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <td><strong>Disponível nestas datas:</strong> <p>Versão de pré-visualização do Beta: 2 de julho a 22 de setembro (em uma implantação em fases)</p> <p>Versão de produção: 2 a 21 de julho de 2020 (em uma implantação em fases)</p> <p><strong>Disponível nestes ambientes:</strong> </p> <p>A nova experiência do Adobe Workfront </p> <p>Adobe Workfront Classic </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/20.3-release-activity/20-3-resource-management-enhancements.md#variable" class="MCXref xref">Filtros de variáveis disponíveis no Balanceador de carga de trabalho</a> </p> <p>Para melhorar sua experiência e fornecer mais flexibilidade ao compartilhar informações, implementamos filtros de variável para o Balanceador de carga de trabalho.</p> </td> 
   <td><strong>Disponível nestas datas:</strong> <p>Versão de pré-visualização do Beta: 5 de junho de 2020</p> <p>Versão de produção: com a versão 20.3</p> <p><strong>Disponível nestes ambientes:</strong> </p> <p>A nova experiência do Adobe Workfront </p> <p>Adobe Workfront Classic </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <td><strong>Disponível nestas datas:</strong> <p>Versão de pré-visualização do Beta: 2 de junho de 2020</p> <p>Versão de produção: com a versão 20.3</p> <p><strong>Disponível nestes ambientes:</strong> </p> <p>A nova experiência do Adobe Workfront </p> <p>Adobe Workfront Classic </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/20.3-release-activity/20-3-resource-management-enhancements.md#workload" class="MCXref xref">Recursos do Balanceador de Carga de Trabalho comunicados anteriormente como lançamento na versão 20.2</a> </p> <p>Vários recursos foram originalmente lançados para o ambiente de Pré-visualização como parte da versão 20.2 e foram removidos posteriormente. Esses recursos estão sendo lançados para Pré-visualização e Produção em uma implantação em fases.</p> </td> 
   <td><strong>Disponível nestas datas:</strong> <p>Versão de pré-visualização do Beta: com a versão 20.2</p> <p>Versão de produção: com a versão 20.3 em uma implantação em fases</p> <p><strong>Disponível nestes ambientes:</strong> </p> <p>A nova experiência do Adobe Workfront </p> <p>Adobe Workfront Classic </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <td><strong>Disponível nestas datas:</strong> <p>Versão de pré-visualização do Beta: N/D</p> <p>Versão de produção: 21 de agosto de 2020</p> <p><strong>Disponível nestes ambientes:</strong> </p> <p>A nova experiência do Adobe Workfront </p> <p>Adobe Workfront Classic </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/20.3-release-activity/20-3-mobile-enhancements.md#zoom" class="MCXref xref">Integração do Zoom na área Atualizações</a> </p> <p>Torne as reuniões de vídeo uma parte do que você faz no Workfront ao iniciar as reuniões de zoom na área Atualizações. Clique no ícone Zoom para inserir um URL de reunião em um comentário e marcar colegas de trabalho para notificá-los sobre a reunião. Para participar, basta clicar no link.</p> </td> 
   <td><strong>Disponível nestas datas:</strong> <p>Versão de visualização do Beta: 20 de julho de 2020</p> <p>Versão de produção: com a versão 20.3</p> <p><strong>Disponível nestes ambientes:</strong> </p> <p>A nova experiência do Adobe Workfront </p> <p>Adobe Workfront Classic </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   ...
   <td><strong>Disponível nestas datas:</strong> <p>Versão de pré-visualização do Beta: 1 de junho de 2020</p> <p>Versão de produção: com a versão 20.3</p> <p><strong>Disponível nestes ambientes:</strong> </p> <p>A nova experiência do Adobe Workfront </p> <p>Adobe Workfront Classic </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <td><strong>Disponível nestas datas:</strong> <p>Versão de pré-visualização do Beta: 2 de julho de 2020</p> <p>Versão de produção: 16 de julho de 2020</p> <p><strong>Disponível nestes ambientes:</strong> </p> <p>A nova experiência do Adobe Workfront </p> <p>Adobe Workfront Classic </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <td><strong>Disponível nestas datas:</strong> <p>Versão de pré-visualização do Beta: 2 de julho de 2020</p> <p>Versão de produção: 16 de julho de 2020</p> <p><strong>Disponível nestes ambientes:</strong> </p> <p>A nova experiência do Adobe Workfront </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   ...
   <td><strong>Disponível nestas datas:</strong> <p>Versão de pré-visualização do Beta: 3 de junho de 2020</p> <p>Versão de produção: 18 de junho de 2020</p> <p><strong>Disponível nestes ambientes:</strong> </p> <p>A nova experiência do Adobe Workfront </p> <p>Adobe Workfront Classic </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
  ...
  <tr data-mc-conditions=""> 
   <td> <p>Codificação <a href="../../../product-announcements/product-releases/20.3-release-activity/20-3-other-enhancements.md#base64" class="MCXref xref">Base64 para Assinaturas de Eventos</a> </p> <p>O campo base64Encoding é um campo opcional usado para habilitar a codificação Base64 de conteúdos de assinaturas de eventos. Se uma solicitação for feita usando o campo base64Encoding definido como true, os objetos newState e oldState na carga serão entregues como strings de codificação Base64. Esse recurso pode ser útil se sua rede estiver configurada de forma a não permitir caracteres especiais em Assinaturas de eventos.</p> </td> 
