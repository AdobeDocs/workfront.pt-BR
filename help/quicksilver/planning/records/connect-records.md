...
<tr> 
  ...
  <tr> 
   ...
   <p>Gerenciar permissões para o registro do qual você está se conectando</p>
   <p>Exibir ou ter permissões mais altas para o registro ao qual você está se conectando</p>
