...
* A restrição Deve Terminar em não tem efeito em uma tarefa com subtarefas. Uma tarefa com subtarefas sempre tem seu próprio Início Planejado, Conclusão Planejada e Duração totalizados a partir do Início mais antigo da subtarefa e das Datas de Conclusão mais recentes da subtarefa, independentemente da restrição aplicada a ela. Você deve associar a restrição Deve Terminar Em diretamente com a subtarefa que precisa da data fixa. O pai continuará a acumular automaticamente.
