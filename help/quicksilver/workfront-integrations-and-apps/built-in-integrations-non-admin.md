...
As seguintes integrações integradas estão disponíveis atualmente no Workfront.
  ...
  <tr> 
   ...
   <td> 
    <ul> 
     ...
     <li>Funciona em ambos [!DNL Jira] Servidor e Jira Cloud </li> 
    </ul> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 
    <ul> 
     ...
     <li> <p class="TableStyle-TableStyle-List-options-in-steps-BodyD-Column2-MediumGray">Conectar aplicativos e serviços Web a [!DNL Workfront]</p> </li> 
    </ul> </td> 
  </tr> 
 </tbody> 
</table>
