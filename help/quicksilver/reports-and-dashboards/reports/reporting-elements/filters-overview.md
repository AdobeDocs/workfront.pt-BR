...
Este é um exemplo do construtor de filtros herdados:

![Construtor de filtros herdados](assets/filter-statements-with-or-and-and-nwe.png)
...
Você pode criar um filtro usando a interface padrão ou do construtor herdado das seguintes maneiras:
