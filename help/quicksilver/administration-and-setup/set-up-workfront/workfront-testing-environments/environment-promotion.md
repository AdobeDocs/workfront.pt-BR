...
| Objeto promovível | Subobjetos incluídos |
| --- | --- |
...
2. descrição (sequência de caracteres)
3. origem (string com validação de URL)
4. status (string com validação de valor)
5. versão (número inteiro)
6. metadados (coleção)
7. packageEntities (coleção)
