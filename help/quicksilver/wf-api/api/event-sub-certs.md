...
>[!NOTE]
>
>* Por padrão, o Workfront atualmente é compatível com a versão 1.2 do TLS.
>* As organizações podem solicitar que o TLS versão 1.3 seja habilitado para sua instância do Workfront.
