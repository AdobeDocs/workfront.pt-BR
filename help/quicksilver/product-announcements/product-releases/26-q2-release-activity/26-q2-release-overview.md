...
<table>
   ...
   <tr>
        ...
        <td><p>quarta-feira, 31 de março de 2026</p></td>
        <td><p>quarta-feira, 31 de março de 2026</p></td>
        <td><p>quarta-feira, 31 de março de 2026</p></td>
    </tr>
    <tr>
...
<table>
    ...
    <tr>
        <td>
           ...
           <td><p>N/D</p><p>As exibições predefinidas não terão uma versão de Visualização e serão liberadas diretamente para Produção. </p></td>
        <td><p>A ser definido</p></td>
        <td><p>A ser definido</p></td>
 </tr>
    <tr>
