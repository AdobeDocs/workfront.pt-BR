...
>|----|----|
>| <ul><li>26.2 (12 de fevereiro de 2026)</li><li>26.3 (12 de março de 2026)</li><li>26.4 (15 de abril de 2026)</li></ul> | <ul><li>26.4 (16 de abril de 2026)</li></ul> |
>
...
* [Aprimoramentos nas operações corporativas](#enterprise-operations-enhancements)
...
<table>
   ...
   <tr>
    ...
    <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q2-release-activity/26-q2-documents.md" class="MCXref xref" xrefformat="{para}">Minhas atualizações de widget de aprovação </a><p></p>
            <p>Adicionamos as seguintes melhorias ao widget Minhas aprovações na Página inicial:<ul><li>Classifique a lista de aprovações por Mais antigo primeiro ou Mais recente primeiro</li><li>Expandir o widget para tela inteira</li><ul> </p>
        </td>
        <td><p>2 de abril de 2026</p></td>
        <td><p>15 de abril de 2026</p></td>
        <td><p>16 de abril de 2026</p></td>
...
### Aprimoramentos nas operações corporativas
...
<table>
    ...
    <tr>
        ...
        <td><p>5 de fevereiro de 2026</p></td>
...
<table>
    ...
    <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q2-release-activity/26-q2-requests.md" class="MCXref xref" xrefformat="{para}">Melhorias na visibilidade do objeto criado nas listas de solicitações </a><p></p>
            <p>Agora você pode visualizar e abrir tarefas e projetos convertidos de problemas do Workfront na nova experiência de solicitações, no campo Objeto criado.</p><p>Além disso, adicionamos o campo Status do objeto criado para indicar o status do objeto convertido. </p>
        </td>
           <td><p>2 de abril de 2026</p></td>
        <td><p>15 de abril de 2026</p></td>
        <td><p>16 de abril de 2026</p></td>
...
<table>
    ...
    <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q2-release-activity/26-q2-other.md" class="MCXref xref" xrefformat="{para}">Aplicar formatação condicional às listas de solicitações enviadas na área Solicitações e ao widget Minhas solicitações</a><p></p>
            <p>Agora você pode aplicar formatação condicional a listas de solicitações na área Solicitações e ao widget Minhas solicitações na Página inicial. Essa funcionalidade não existia na exibição de lista antes dessa melhoria.</p>
        </td>
           <td><p>2 de abril de 2026</p></td>
        <td><p>15 de abril de 2026</p></td>
        <td><p>16 de abril de 2026</p></td>
    ...
    <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q2-release-activity/26-q2-other.md" class="MCXref xref" xrefformat="{para}">Criar agrupamentos na lista Solicitações e no widget Minhas Solicitações </a><p></p>
            <p>Para facilitar a localização das solicitações necessárias, adicionamos agrupamentos à lista Solicitações e ao widget Minhas solicitações. Agora é possível agrupar solicitações por qualquer coluna na lista. Esses agrupamentos se tornam parte da exibição que você está usando ao criar o agrupamento.</p>
        </td>
           <td><p>2 de abril de 2026</p></td>
        <td><p>15 de abril de 2026</p></td>
        <td><p>16 de abril de 2026</p></td>
