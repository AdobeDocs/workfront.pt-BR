...
title: Visualizar itens recentes
...
1. Clique no ícone **[!UICONTROL Recentes]** ![[!UICONTROL Recentes]](assets/recents-icon.png) no canto superior direito de qualquer página.

   ![Lista de recentes](assets/recents-list.png)
