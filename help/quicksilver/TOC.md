...
* Anúncios de produtos {#product-announcements}
   ...
   * Versões do produto {#product-releases}
      ...
      * Versão 23.3 {#release-23-3}
         ...
         * [Atualizações de aparência durante o período de lançamento da versão 23.3](product-announcements/product-releases/23.3-release-activity/23-3-look-and-feel-updates.md)
   ...
   * Programas Beta {#beta}
      ...
      * Nova experiência de comentário beta {#new-commenting-experience-beta}
         ...
         * [Novo comentário sobre a atividade de lançamento de experiência beta](product-announcements/betas/new-commenting-experience-beta/new-commenting-beta-experience-release-activity.md)
