...
## Nova aparência para mensagens do Centro de notificações
...
As mensagens do Centro de notificações agora correspondem ao estilo das notificações por email do Workfront.
