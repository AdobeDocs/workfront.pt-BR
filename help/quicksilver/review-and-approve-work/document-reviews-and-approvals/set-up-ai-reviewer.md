...
title: Criar revisores de conteúdo
description: Depois de ter pelo menos uma marca configurada no Workfront, você pode criar vários Revisores de conteúdo, que podem ser atribuídos a modelos de aprovação e a solicitações individuais de revisão e aprovação.
author: Courtney
...
Depois de ter pelo menos uma marca configurada no Workfront, você pode criar vários Revisores de conteúdo, que podem ser atribuídos a modelos de aprovação e a solicitações individuais de revisão e aprovação.
...
## Adicionar um revisor de conteúdo
...
1. No painel esquerdo, vá para **Revisão e Aprovação** > **Revisores de Conteúdo**.
1. Clique em **Adicionar novo**.
1. Nomeie o revisor.
1. Selecione uma **Marca**.
1. Selecione uma das seguintes opções no menu suspenso **Tipo de diretriz**:
   * **Imagem**: o revisor de conteúdo revisará o ativo de acordo com as diretrizes da marca da imagem que você configurou no Workfront.
...
1. Clique em **Criar**.
   ...
   Depois que o Revisor de conteúdo for criado, os usuários poderão adicioná-lo aos modelos de aprovação ou aprovações individuais.
