...
description: Esta página fornece informações sobre a funcionalidade incluída na versão 2019.3. A funcionalidade nesta página foi disponibilizada no ambiente de Produção da semana de 19 de agosto de 2019. Para obter datas e horas específicas que explicam quando a versão foi disponibilizada, consulte o Site de confiança da Workfront.
author: Luke
...
Esta página fornece informações sobre a funcionalidade incluída na versão 2019.3. A funcionalidade nesta página foi disponibilizada no ambiente de Produção da semana de 19 de agosto de 2019.
...
Para exibir uma lista de aprimoramentos lançados após a versão 2019.3, consulte [Versões do produto](../../../../product-announcements/product-releases/product-releases.md).
...
* [O filtro Abrir agora mostra mais resultados em uma lista de Problemas](../../../../product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019-3-project-enhancements.md#changes)
  ...
  Quando você aplica o filtro Abrir a uma lista de problemas, a lista inclui problemas que estão em um status Fechado - Aprovação pendente ou que estão associados a um objeto de resolução.
  ...
  * <MadCap:conditionalText data-mc-conditions="OnlineOrPDF.OnlineOnly">  <a href="../../../../product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019-3-project-enhancements.md#new" class="MCXref xref" xrefformat="{para}">New experience when inline editing information in lists</a> </MadCap:conditionalText><MadCap:conditionalText data-mc-conditions="OnlineOrPDF.PrintOnly">  <a href="https://experience.workfront.com/s/article/2019-3-Project-enhancements-1332102832" target="_blank" data-mc-conditions="QuicksilverOrClassic.Draft mode">New experience when inline editing information in lists</a> </MadCap:conditionalText>
  ...
  Quando você editar as informações em linha nas novas listas, as linhas que foram editadas ficarão esmaecidas, mas as informações permanecerão visíveis.
...
* [Editar Gantt sem Ativar um Modo de Edição Especial](../../../../product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019-3-project-enhancements.md#edit)
  ...
  Agora você pode editar o gráfico de Gantt da lista de tarefas quando o salvamento automático estiver ativado ou não.

* [Listas atualizadas para as guias de horas de projetos, tarefas e problemas](../../../../product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019-3-project-enhancements.md#updated2)
...
* [Criar um relatório de horas orçadas](../../../../product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019-3-resource-planning-enhancements.md#build)
...
* [Novas configurações para ocultar a coluna Horas efetivas no Planejador de recursos](../../../../product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019-3-resource-planning-enhancements.md#new2)
...
* [Os conjuntos de recursos são mantidos na área Orçamento de recursos do Business Case](../../../../product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019-3-resource-planning-enhancements.md#resource)
...
* [O acesso aos dados financeiros para Taxas de Custo afeta as informações no Planejador de Recursos que são exibidas por custo](../../../../product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019-3-resource-planning-enhancements.md#financia)
  ...
  Os administradores do Workfront agora podem determinar quais usuários têm acesso para exibir ou editar informações de custo de funções, usuários ou projetos no Planejador de recursos.

### Integração e aprimoramentos móveis

* [Suporte a itens compartilhados na integração com o MS OneDrive](../../../../product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019-3-integration-mobile-enhancements.md#support)
  ...
  Agora você pode vincular seus arquivos e pastas compartilhados do OneDrive a objetos do Workfront.

* [Especificação de domínio necessária para todos os logons da Workfront](../../../../product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019-3-integration-mobile-enhancements.md#domain)
  ...
  Todos os logons do Workfront agora exigem que o usuário especifique o domínio se ele ainda não estiver especificado no URL do Workfront. Solicitar essas informações torna sua instância do Workfront mais segura.

* Aplicativo móvel Workfront disponível para Blackberry Marketplace (Em breve)

  O aplicativo móvel do Workfront está chegando em uma versão futura do Blackberry Dynamics para Blackberry Marketplace.
...
* [Converter tarefas e problemas em projetos usando o aplicativo móvel no iOS](../../../../product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019-3-integration-mobile-enhancements.md#convert)
  ...
  Agora você pode converter tarefas e problemas individuais em projetos no aplicativo móvel do Workfront.

* [Faça logon no aplicativo móvel com impressão digital ou ID facial](../../../../product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019-3-integration-mobile-enhancements.md#log)
  ...
  Dependendo do dispositivo, você pode optar por fazer logon no aplicativo móvel do Workfront usando a tecnologia de impressão digital ou ID facial.

* [Nova configuração para desconectar usuários automaticamente em dispositivos móveis](../../../../product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019-3-integration-mobile-enhancements.md#new2)
  ...
  Para tornar o aplicativo móvel Workfront mais seguro para você e sua empresa, os usuários serão desconectados automaticamente após 8 minutos de inatividade.
...
* [Atualizações da aparência na Página inicial](../../../../product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019-3-home-enhancements.md#new3)
...
### Melhorias no lançamento antes da versão geral 2019.3

Esta seção descreve as alterações feitas durante o período de lançamento da versão 2019.3 do que será lançada no ambiente de produção antes do lançamento geral da versão 2019.3.
...
* [Criar calendários e relatórios de folga](../../../../product-announcements/product-releases/quarterly-release-archive/2019.3-release-activity/2019-3-project-enhancements.md#create)
...
Agora, ao comentar em um documento, sua atualização aparecerá na guia Atualizações tanto para o documento quanto para o objeto ao qual o documento está anexado.
...
Criamos um novo tipo de campo no construtor de formulários personalizado chamado Digitação antecipada. Este campo permite adicionar campos que representam objetos aos seus formulários personalizados.
...
0### Funcionalidade sendo removida
