...
title: Visão geral da duração da tarefa e tipos de duração
...
TQID: https://experienceleague.adobe.com/b0P3LF-lB3xH0oDs2bbAg-JfUOVFyXRpE8xZrrudedg
...
# Visão geral da duração da tarefa e tipos de duração
...
![Duração de dias decorridos nas tarefas](assets/duration-elapsed-days-tasks-nwe-350x282.png)
