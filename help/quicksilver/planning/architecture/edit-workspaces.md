...
Você pode editar um espaço de trabalho das seguintes maneiras:

* Manualmente.

  Este artigo descreve como editar manualmente um espaço de trabalho.

* Uso da Designer do Planning habilitada por IA. No momento, esse recurso está disponível apenas em um programa Beta limitado.
...
1. (Condicional) Se você for um administrador do Workfront, clique em uma das seguintes opções:
   ...
   * **Todos os espaços de trabalho** para acessar espaços de trabalho compartilhados com você ou com espaços de trabalho que você criou
   ...
   >[!NOTE]
   >
   ><span class="preview">Não é possível editar os espaços de trabalho na guia **Espaços de trabalho de exemplo**. Recomendamos usar o pacote de modelos de vários espaços de trabalho para criar espaços de trabalho semelhantes aos da guia Espaço de trabalho de amostra e editar os seus próprios. Para obter informações, consulte [Criar espaços de trabalho](/help/quicksilver/planning/architecture/create-workspaces.md).</span>
