...
1. **Usar o conector de Revisão e Aprovações Unificadas do Adobe Workfront ao recompilar.** Os conectores atualizados expõem módulos criados especificamente para revisão e aprovação unificadas e tornam as reconstruções significativamente mais simples e confiáveis. Não recomendamos a recriação com antecedência em relação à API do Workfront versão 22.
