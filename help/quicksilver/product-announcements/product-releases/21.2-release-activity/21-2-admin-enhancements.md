...
title: Aprimoramentos de admin na 21.2
...
# Aprimoramentos de admin na 21.2
...
Este recurso agora está incluído no [Fundamentos do administrador para a nova experiência do Workfront, Parte 2: Caminho de Aprendizado da Instalação do Projeto](https://experienceleague.adobe.com/pt-br/docs/workfront-learn/tutorials-workfront/home?lang=pt-BR) no Workfront One.
...
Para obter informações sobre as listas modernizadas em todo o Workfront, consulte [Modificar como uma lista é exibida](../../../workfront-basics/navigate-workfront/use-lists/modify-list-display.md).
...
Este recurso agora está incluído no [Fundamentos do administrador no novo caminho de aprendizado da Workfront Experience, Parte 3: Experiência de controle e interface](https://experienceleague.adobe.com/pt-br/docs/workfront-learn/tutorials-workfront/home?lang=pt-BR) no Workfront One.
...
* [Visualizar e gerenciar membros do subgrupo](../../../administration-and-setup/manage-groups/create-and-manage-subgroups/view-and-manage-subgroup-members.md)
