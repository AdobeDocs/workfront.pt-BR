...
## Resumir usando os botões Resumir
...
1. Clique no botão.
   ...
   O Assistente de IA é aberto, com um prompt para resumir o projeto ou os últimos 7 dias de comentários no fluxo de atualização.
