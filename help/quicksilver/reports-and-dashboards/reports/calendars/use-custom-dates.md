...
1. Você deve ter campos de data personalizados e um valor dentro do campo disponível em sua instância [!DNL Workfront]. Se você não tiver um formulário personalizado configurado com datas personalizadas, siga as instruções nas duas primeiras seções em [Criar ou editar um formulário personalizado](../../../administration-and-setup/customize-workfront/create-manage-custom-forms/create-or-edit-a-custom-form.md).
