...
1. Clique no nome de um painel existente para abri-lo.
   ![Abrir um painel](assets/open-dashboard.png)
1. Localize o relatório de tabela que deseja personalizar.
1. Escolha qualquer uma das seguintes opções para personalizar o relatório:

   | Opção | Descrição |
   |--------|-------------|
   | **Adicionar coluna** | Clique em **Adicionar coluna** para adicionar outras colunas ao relatório. |
   | **Configurar colunas** | Escolha mostrar ou ocultar colunas específicas no relatório. |
   | **Altura da linha** | Ajuste a altura da linha para o relatório. |
   | **Rolagem de snap** | Ative ou desative a rolagem de snap para facilitar a navegação pelo relatório. |
