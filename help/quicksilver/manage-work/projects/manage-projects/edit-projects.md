...
1. Clique para selecionar formulários personalizados adicionais na **Adicionar formulário personalizado** ou **Forms a adicionar** subseções quando ele é exibido na lista.
