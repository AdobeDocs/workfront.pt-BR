---
title: Aprimoramentos nos documentos do segundo trimestre de 2026
description: Aprimoramentos nos documentos do segundo trimestre de 2026
author: Becky
...
Os clientes não serão cobrados por esse novo produto.

## Minhas atualizações de widget de aprovação
...
* Classifique a lista de aprovações por Mais antigo primeiro ou Mais recente primeiro
* Expandir o widget para tela inteira

Para obter mais informações, consulte [Gerenciar suas aprovações com o widget Minhas aprovações](/help/quicksilver/workfront-basics/using-home/using-the-home-area/my-approvals-widget.md).
...
* Definir prazos específicos para cada estágio
* Garanta o progresso das aprovações somente quando as decisões necessárias estiverem concluídas
* Manter visibilidade do progresso da aprovação
...
* Criar estágios de aprovação sequenciais com participantes e prazos exclusivos
* Reduzir o tempo de configuração manual durante o início da aprovação
* Garantir que as partes interessadas necessárias estejam envolvidas no estágio certo
