...
Este artigo lista os recursos que foram lançados durante a fase inicial do Workfront Planning, em 2024, antes do lançamento de disponibilidade geral em 28 de agosto de 2024.
...
Você pode acessar a visualização ou o espaço de trabalho a partir da notificação por email, quando a permissão for concedida.  <!--see if they also get an in-app notification-->

>[!NOTE]
>
>Sua organização deve estar integrada à Adobe Unified Experience para que os usuários possam solicitar e conceder permissões para uma visualização ou um espaço de trabalho a partir de uma solicitação de permissão.
...
Não é possível criar outros objetos conectados do Workfront ou ativos do Experience Manager ao conectá-los a um registro.
...
* Ao conectar tipos de registro a ativos do Experience Manager
...
* As pessoas que acessam a exibição por meio do link público não podem criar outras exibições, editar a exibição compartilhada ou adicionar, excluir ou editar informações de registro.
...
* A linha do tempo é criada com base no primeiro valor de data.
...
### A importação do Excel do tipo de registro foi removida temporariamente
