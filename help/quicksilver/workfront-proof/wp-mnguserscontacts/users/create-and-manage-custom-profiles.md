...
1. Clique no menu suspenso **[!UICONTROL Mais]** e, em seguida, clique em qualquer uma das opções a seguir, dependendo se você deseja habilitar ou desabilitar o perfil:
