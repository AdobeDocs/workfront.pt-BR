...
title: Visão geral dos usos comuns do modo de texto
description: Visão geral dos usos comuns do modo de texto
author: Nolan
...
# Visão geral dos usos comuns do modo de texto
...
Você pode expandir seus recursos de relatórios usando o modo de texto em relatórios e elementos de relatório. Você também pode usar uma versão do modo de texto para criar campos personalizados calculados mais complexos. Para obter mais informações sobre o modo de texto, consulte [Visão geral do modo de texto](../../../reports-and-dashboards/reports/text-mode/understand-text-mode.md).
...
Para obter exemplos adicionais do modo de texto real que outros clientes da Workfront podem ter identificado, visite o [Discussões dos Relatórios no Modo de Texto](https://one.workfront.com/s/topic/0TO0z000000cdHmGAI/text-mode-reporting?tabset-21363=3) no Adobe Workfront One ou participe da [Comunidade Workfront](https://one.workfront.com/s/community) (requer fazer logon).  

## Instâncias em que você pode usar o modo de texto em listas e relatórios

Recomendamos usar o construtor de relatórios e listas para criar exibições, filtros e agrupamentos. No entanto, há algumas instâncias em que você pode usar o modo de texto para aprimorar seus relatórios e listas.

Você pode usar o modo de texto quando quiser alcançar o seguinte no Workfront:

* Crie campos personalizados calculados e personalizados em um formulário personalizado.\
   Para obter mais informações sobre campos personalizados calculados, consulte o [Usar o modo de texto em campos personalizados calculados](#use-text-mode-in-calculated-custom-fields) neste artigo.
* Melhore filtros, visualizações e agrupamentos além do que é possível no construtor de relatórios. Para obter informações sobre como usar o modo de texto para filtros, visualizações e agrupamentos, consulte as seguintes seções neste artigo:

   * [Usar o modo de texto em exibições](#use-text-mode-in-views)
...
Você pode usar o modo de texto para adicionar um campo personalizado calculado a um Formulário personalizado.
...
Por exemplo, é possível adicionar um campo personalizado calculado que mostra um carimbo de data e hora do momento em que um item foi marcado como Em andamento. Você pode usar esse cálculo para outros status.

Para obter mais informações, consulte [Exemplo de campo personalizado calculado: exibir um carimbo de data e hora de Status em um Formulário personalizado](../../../reports-and-dashboards/reports/calc-cstm-data-reports/example-status-timestamp-in-calculated-field.md).
...
É possível usar o modo de texto em visualizações para expandir os campos e objetos que podem ser exibidos na visualização.
...
Você pode usar o modo de texto ao criar filtros para expandir os campos e objetos pelos quais pode filtrar.
...
* A seção [Exemplos de filtros de modo de texto que abrangem vários níveis na hierarquia de objetos](../../../reports-and-dashboards/reports/text-mode/create-complex-text-mode-filters-using-exists-statements.md#examples) no artigo [Criar filtros complexos do Modo de texto usando instruções EXISTENTES](../../../reports-and-dashboards/reports/text-mode/create-complex-text-mode-filters-using-exists-statements.md)
* A seção [Criar filtros de modo de texto complexo para objetos ausentes](../../../reports-and-dashboards/reports/text-mode/create-complex-text-mode-filters-using-exists-statements.md#missing-object-filters) no artigo [Criar filtros complexos do Modo de texto usando instruções EXISTENTES](../../../reports-and-dashboards/reports/text-mode/create-complex-text-mode-filters-using-exists-statements.md)
...
É possível usar o modo de texto ao criar agrupamentos para expandir os campos e objetos que podem ser agrupados em listas e relatórios.
