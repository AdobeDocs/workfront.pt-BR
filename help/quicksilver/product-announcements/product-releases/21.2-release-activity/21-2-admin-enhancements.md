...
Para obter informações sobre a preferência de Horas e planilhas de horas, consulte [Configurar preferências de horas e planilha de horas](../../../administration-and-setup/set-up-workfront/configure-timesheets-schedules/timesheet-and-hour-preferences.md).
...
Para obter informações sobre as listas modernizadas no Workfront, consulte [Modificar como uma lista é exibida](../../../workfront-basics/navigate-workfront/use-lists/modify-list-display.md).
...
Para obter mais informações sobre a área Configuração, consulte [Administração e configuração](../../../administration-and-setup/administration-and-setup.md).

## Para administradores de grupo: Exibir e gerenciar mais objetos de grupo na página Grupos
...
* [Criar e modificar os projetos de um grupo](../../../administration-and-setup/manage-groups/work-with-group-objects/create-and-modify-a-groups-portfolios.md)
...
Para obter mais informações, consulte [Criar, editar e atribuir perfis de planilha de horas](../../../timesheets/create-and-manage-timesheets/create-timesheet-profiles.md).
...
Esse recurso agora está incluído na [Princípios básicos do administrador na nova experiência do Workfront, Parte 3: Experiência em controle e interface](https://one.workfront.com/s/learningpath3/administrator-fundamentals-control-and-interface-experience-MCNCSSMXLPDFEERGVEM4EWL2I4LI) Caminho de Aprendizado no Workfront One.
...
Para obter mais informações, [Exibir todos os relatórios que usam um campo ou widget personalizado específico](../../../administration-and-setup/customize-workfront/create-manage-custom-forms/view-all-reports-that-use-a-particular-custom-field.md).
...
## Novo para administradores: mais opções de formatação de texto disponíveis nos campos de Formulário personalizado
