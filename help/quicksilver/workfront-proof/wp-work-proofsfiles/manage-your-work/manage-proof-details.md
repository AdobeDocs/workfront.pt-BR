...
* Informações básicas de prova:
   ...
   * **Nome do arquivo**: para provas combinadas, você pode **[!UICONTROL Clicar para exibir]** uma lista de arquivos contidos na prova.
