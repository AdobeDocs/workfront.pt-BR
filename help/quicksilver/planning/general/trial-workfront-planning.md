...
>[!IMPORTANT]
>
>O período de teste do Adobe Workfront Planning termina em 15 de maio de 2026. Este artigo permanecerá ativo por um período, mas será removido em breve. Recomendamos que você atualize seus marcadores para o futuro.

As informações neste artigo descrevem a funcionalidade que estava disponível durante o período de avaliação do Workfront Planning.
...
Depois que o administrador do Workfront aceitar o contrato e se inscrever para a avaliação gratuita, o Workfront Planning estará disponível para todos na organização a partir de 2 de março de 2026.
...
## Pré-requisitos para ingressar no teste

Sua empresa deve atender aos seguintes requisitos para poder participar da avaliação gratuita do Workfront Planning:
...
Todos os usuários em sua organização recebem o seguinte pacote do Workfront Planning e o nível de permissões para o Workfront Planning durante a avaliação:
...
1. Siga um destes procedimentos:
   ...
   * Siga o banner no aplicativo que contém informações sobre a **avaliação do Workfront Planning**

   * Vá para a **área Notificações do Workfront** no canto superior direito da tela, clique em **Todos os Anúncios** e localize a mensagem do Centro de Notificações sobre a avaliação do Workfront Planning.
...
1. (Condicional) Se você não for um Administrador do Sistema, siga o banner no aplicativo que contém informações sobre a **avaliação do Workfront Planning** e clique em **Saiba mais**.

   Você pode ler mais sobre a versão de avaliação do Workfront Planning e sobre o Workfront Planning neste artigo.

### Inscreva-se na versão de avaliação do Planning entre 2 de março e 1 de abril de 2026
...
1. Clique em **Aceitar**, depois de revisar o contrato.
   ...
   * A área Planejamento é adicionada ao Menu Principal para você e todos os usuários em seu sistema e mostra um indicador de **Avaliação**.
   * Como um Administrador do Sistema, você recebe acesso de Gerenciar para a guia **Espaços de trabalho de amostra** na área do Planning.
   * Os usuários padrão recebem acesso de Exibição à guia **Espaços de trabalho de amostra** no Planning e podem criar seus próprios espaços de trabalho, tipos de registro, registros, campos e exibições e compartilhá-los com outras pessoas.
   * Todos os outros usuários recebem acesso de Visualização à guia **Espaços de trabalho de amostra** na área do Planning e podem obter acesso a outros espaços de trabalho quando outros os compartilham com eles.
1. (Condicional) Se você não for um Administrador do Sistema e seu Administrador do Sistema ainda não tiver aceito o contrato de avaliação, siga o banner no aplicativo que contém informações sobre a **avaliação do Workfront Planning** e clique em **Saiba mais**.

   Você pode ler mais sobre a versão de avaliação do Workfront Planning e sobre o Workfront Planning neste artigo.
1. (Condicional) Se você não for um Administrador do Sistema e seu Administrador do Sistema tiver aceitado o contrato de avaliação, siga o banner no aplicativo que contém informações sobre a **avaliação do Workfront Planning** e clique em **Abrir Planning**.
