...
Analise as seguintes seções no atual [!UICONTROL Início] conforme realçado na imagem acima:

* **A**: use o painel esquerdo para filtrar, classificar e selecionar o trabalho atribuído a você.
...
Para obter mais informações sobre como usar o [!UICONTROL Lista de trabalho da página inicial], consulte os seguintes artigos:
...
* **A**: Use o [!UICONTROL Calendário] visualização para criar um mapa visual do trabalho que você precisa concluir. Basta clicar e arrastar os itens de trabalho da [!UICONTROL Lista de trabalho] em para o [!UICONTROL Calendário] para bloquear o tempo de trabalho.

* **B**: Use o [!UICONTROL Calendário]opção de sincronização do para sincronizar com o [!DNL Outlook] calendário. Gerencie reuniões e trabalhe tudo em um único local.

* **C**: Use o [!UICONTROL Detalhes] botão para abrir um novo painel direito, onde você pode ver mais informações sobre o item de trabalho.

* **D**: use a barra de vencimento para acompanhar quando o trabalho atribuído a você vence.

Para obter mais informações sobre como usar o Calendário da página inicial, consulte [Use o [!UICONTROL Calendário da página inicial] exibir](../../../workfront-basics/using-home/using-the-home-area/use-home-calendar-view.md).
...
Para obter mais informações sobre como usar agrupamentos, consulte [Exibir itens no [!UICONTROL Lista de trabalho] no [!UICONTROL Início] área](../../../workfront-basics/using-home/using-the-home-area/display-items-in-home-work-list.md).

![](assets/group-by-drop-down-expanded-in-home-with-planned-start-date-nwe-350x273.png)

### Restrinja seu foco com filtros

A variável [!UICONTROL Lista de trabalho] O filtro permite restringir seu foco a itens de trabalho específicos.

A seguir estão exemplos de como você pode filtrar itens exibidos na Página inicial:

* Filtrar por tipo de item e estado.

  Por exemplo, se você deseja exibir todas as tarefas, é possível selecionar a variável [!UICONTROL Tarefas] filtro. Se quiser ser mais específico que isso e exibir somente tarefas prontas para começar a trabalhar, selecione a opção [!UICONTROL Pronto para iniciar] filtros sob o [!UICONTROL Tarefas] filtro.
...
>[!NOTE]
>
>Quaisquer itens de trabalho adicionados a [!UICONTROL Minhas Prioridades] são visíveis apenas para você e ninguém pode priorizar o trabalho para você.

Para obter mais informações sobre como usar [!UICONTROL Minhas Prioridades], consulte [Priorizar o trabalho na [!UICONTROL Início] área](../../../workfront-basics/using-home/using-the-home-area/prioritize-work-in-home.md).
...
Acompanhe as horas trabalhadas em itens de trabalho individuais. Você pode escolher um tipo de hora geral, como [!UICONTROL Tempo em Tarefa]ou você pode escolher um tipo de hora específico do projeto, configurado pelo seu [!DNL Workfront] administrador.

Para obter mais informações sobre como registrar horas na variável [!UICONTROL Início] , consulte a seção [Início](../../../timesheets/create-and-manage-timesheets/log-time.md#home) no artigo [Registrar tempo](../../../timesheets/create-and-manage-timesheets/log-time.md).
