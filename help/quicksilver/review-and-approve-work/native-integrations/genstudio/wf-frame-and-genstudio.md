...
title: Introdução à integração do GenStudio for Performance Marketing e do Frame.io
description: Introdução à integração do GenStudio for Performance Marketing e do Frame.io
author: Courtney
...
# Introdução à integração do GenStudio for Performance Marketing e do Frame.io

Com a integração entre o GenStudio for Performance Marketing e o Frame.io, é possível

* Usar modelos unificados de aprovação do Workfront para definir workflows de revisão e aprovação
...
Se o processo de revisão de conteúdo da sua organização for repetido com frequência ou revisado pelas mesmas pessoas, você poderá usar modelos de aprovação unificados para automatizar os workflows de revisão e aprovação.

### Criar um modelo de aprovação unificado no Workfront

É possível criar modelos simples, de estágio único, para apenas um ou dois revisores, ou criar modelos de vários estágios para revisões complexas com muitos estágios e dependências.

Para obter mais informações sobre como criar modelos de fluxo de trabalho de aprovação no Workfront, consulte [Criar um modelo de fluxo de trabalho de aprovação para documentos](/help/quicksilver/review-and-approve-work/document-reviews-and-approvals/manage-document-approvals/create-approval-template.md).
...
Você pode revisar e aprovar o conteúdo de rascunho diretamente no GenStudio for Performance Marketing no visualizador Frame.io.

Com o visualizador Frame.io, você pode
