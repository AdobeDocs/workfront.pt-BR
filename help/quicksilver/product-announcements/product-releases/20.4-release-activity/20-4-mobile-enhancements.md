---
title: Aprimoramentos de dispositivos móveis e na integração na 20.4
description: Aprimoramentos de dispositivos móveis e na integração na 20.4
author: Luke
draft: Probably
...
# Aprimoramentos de dispositivos móveis e na integração na 20.4
...
Para facilitar o uso do Workfront por meio do Microsoft Teams, adicionamos uma nova funcionalidade às notificações do Microsoft Teams enviadas pelo Workfront.

* Expandimos os tipos de notificações que você pode receber no Microsoft Teams. Agora você pode receber notificações sobre uma grande variedade de eventos, como quando alguém comenta em sua folha de horas ou deseja que você aprove um documento.
