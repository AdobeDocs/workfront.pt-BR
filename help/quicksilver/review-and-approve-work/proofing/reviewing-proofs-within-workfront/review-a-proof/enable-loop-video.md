...
title: Habilitar loop em uma prova de vídeo
description: Você pode configurar o vídeo para loop contínuo (o vídeo começa a ser reproduzido novamente após sua conclusão).
author: Courtney
...
# Habilitar loop em uma prova de vídeo

Você pode configurar o vídeo para loop contínuo (o vídeo começa a ser reproduzido novamente após sua conclusão). 
...
1. No canto inferior direito do visualizador de prova, clique no botão **Configurações** ícone .

   ![phq_viewer_video_playbackspeed__3_.png](assets/phq-viewer-video-playbackspeed--3-.png)

1. Ative o **Loop** opção.
