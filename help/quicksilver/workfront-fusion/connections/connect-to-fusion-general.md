...
title: Criar uma conexão com o [!DNL Adobe Workfront Fusion] - Instruções básicas
description: Muitos [!DNL Adobe Workfront Fusion] Os conectores do não exigem configuração personalizada ao criar uma conexão. Este artigo descreve o processo de criação de conexão padrão.
author: Becky
...
# Criar uma conexão com o [!DNL Adobe Workfront Fusion] - Instruções básicas
...
1. Clique em **[!UICONTROL Adicionar]** ao lado da [!UICONTROL Conexão] para abrir a caixa **[!UICONTROL Criar uma conexão]** painel.
