...
description: As extensões de interface do usuário do Workfront, viabilizadas pelo Adobe App Builder, permitem que clientes e parceiros criem experiências de usuário personalizadas.
author: Courtney
...
Para testar a integração do AppBuilder, você pode solicitar uma avaliação gratuita para sua organização IMS aqui: https://developer.adobe.com/app-builder/trial/#
...
1. Aguarde até ver uma mensagem informando que a inicialização do aplicativo foi concluída. Em seguida, abra o projeto em um IDE (recomenda-se VSCode) e acesse a pasta src.

   Para obter mais informações sobre as pastas e os arquivos do seu projeto, consulte o [site do desenvolvedor do Adobe](https://developer.adobe.com/app-builder/docs/getting_started/first_app/#5-anatomy-of-an-appbuilder-application).
...
Para obter mais informações sobre como desenvolver e executar o aplicativo, consulte o [site do desenvolvedor do Adobe](https://developer.adobe.com/app-builder/docs/getting_started/first_app/#6developing-the-application).
