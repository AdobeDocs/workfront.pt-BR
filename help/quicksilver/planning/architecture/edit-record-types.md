...
Ou
   * <span class="preview">Clique em um cartão de tipo de registro para abrir a página de tipo de registro, clique no menu **Mais** ![Mais menu](assets/more-menu.png) à direita do nome do tipo de registro e clique em **Editar**<!--<span class="preview">or **Settings**</span>. </span>-->
