...
description: Admins do Workfront podem configurar a funcionalidade de revisão, relatórios, emails, segurança, taxas de câmbio, itens excluídos e diagnósticos.
...
# Gerenciar o Adobe Workfront

Esta seção contém as seguintes subseções:

* [Configurar a funcionalidade de revisão](../../administration-and-setup/manage-workfront/configure-proofing/configuring-proofing-functionality.md)
