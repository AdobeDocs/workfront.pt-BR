...
title: Adicionar aprovadores às aprovações de documentos enviadas
description: Você pode adicionar outros aprovadores a uma aprovação de documento diretamente da área Página inicial.
author: Courtney
feature: Work Management, Digital Content and Documents
exl-id: 2418565a-639c-424e-873a-f6512efc5cb5
TQID: https://experienceleague.adobe.com/uhA0S-9PhuT-jwCvftYPTVdUzgoiOXOEmrR6WOXtiDA
product_v2:
...
# Adicionar aprovadores às aprovações de documentos enviadas
...
1. Selecione uma aprovação de **Documento**.

1. Clique em **Gerenciar aprovações** no canto superior direito do painel direito.
1. Na caixa **Solicitar que alguém aprove este documento**, digite o nome do aprovador.
