...
title: Exibir pontuação e feedback do revisor de conteúdo
description: Segundos após enviar a solicitação de aprovação, é possível exibir a pontuação e o feedback do Revisor de conteúdo no painel Resumo do documento.
author: Courtney
...
![Comentários do revisor de conteúdo](assets/ai-reviewer-output.png)
...
![O feedback do revisor de conteúdo precisa de atenção](assets/ai-reviewer-needs-attention.png)
