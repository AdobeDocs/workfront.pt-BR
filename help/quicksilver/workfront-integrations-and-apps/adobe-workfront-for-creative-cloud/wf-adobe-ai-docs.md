...
# Carregar documentos de [!DNL Illustrator]
...
* Você deve instalar o [!DNL Adobe Workfront for design and video] antes de carregar documentos do [!DNL Illustrator].
...
## Carregar documentos para [!DNL Illustrator]
...
>
>1. Em [!DNL Illustrator], clique na guia **[!UICONTROL Editar]** e selecione **[!UICONTROL Preferências]**.
