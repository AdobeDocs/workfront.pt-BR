...
# Use [!UICONTROL Datas Planejadas] em um relatório de calendário

Um relatório de calendário é um relatório dinâmico que fornece uma representação visual do seu trabalho. Você pode usar [!UICONTROL Data planejada] campos em um relatório de calendário para os seguintes objetos:
...
1. Selecione o calendário ao qual deseja adicionar um novo grupo de itens.\
   ...
   >[!NOTE]
   >
   >Você deve ter o acesso Editar aos Relatórios, Painéis e Calendários no seu nível de acesso para criar um relatório de calendário.
   ...
   <table style="table-layout:auto">
    ...
    <tbody>
     ...
     <tr>
      ...
      <td><p>Choose <strong>[!UICONTROL Datas planejadas]</strong>. Para obter mais informações sobre datas planejadas, consulte </p>
       <ul>
