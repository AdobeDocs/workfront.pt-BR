...
description: Em um [!DNL Adobe Workfront Fusion] Neste cenário, você pode automatizar workflows que usam Anaplan, bem como conectá-lo a vários aplicativos e serviços de terceiros.
author: Becky
...
Em um [!DNL Adobe Workfront Fusion] cenário, é possível automatizar workflows que usam [!DNL Anaplan], bem como conectá-lo a vários aplicativos e serviços de terceiros.
...
Antes de poder usar o [!DNL Anaplan] deve garantir que os seguintes pré-requisitos sejam atendidos:

* Você deve ter um ativo [!UICONTROL Anaplan] conta.
* Você deve configurar Espaços de trabalho, Modelos e outros [!DNL Anaplan] objetos em seu [!UICONTROL Anaplan] conta antes [!DNL Workfront Fusion] O pode interagir com eles.

## Conectar [!DNL Anaplan] para [!DNL Workfront Fusion] {#connect-anaplan-to-workfront-fusion}

Para criar uma conexão para o seu [!DNL Anaplan] módulos:

1. Clique em **[!UICONTROL Adicionar]** ao lado da [!UICONTROL Conexão] caixa.
   ...
   <table style="table-layout:auto">
    ...
    <tbody> 
     <tr> 
      ...
      <td> <p>Um [!DNL Anaplan] A conexão [!UICONTROL Basic] requer somente um endereço de email e senha para criar a conexão. </p> <p>Digite um nome para a conexão e, em seguida, digite seu endereço de email e a senha de [!DNL Anaplan] conta.</p> </td> 
     </tr> 
     <tr> 
      <td role="rowheader">[!DNL Anaplan] [!UICONTROL Certificado de Autoridade de Certificação]</td> 
      <td> <p>Um [!DNL Anaplan] A conexão do [!UICONTROL Certificado de Autoridade de Certificação] requer uma [!UICONTROL Chave de Certificado], [!UICONTROL Dados Codificados] e [!UICONTROL Dados Codificados Assinados]. Você pode gerá-los em seu [!DNL Anaplan] conta. Para obter instruções, consulte [!DNL Anaplan] documentação.</p> <p>Insira um nome para a conexão e insira a [!UICONTROL Chave de Certificado], [!UICONTROL Dados Codificados] e [!UICONTROL Dados Codificados Assinados] que você gerou na [!DNL Anaplan] conta.</p> </td> 
     </tr> 
    </tbody> 
   </table>
...
Ao configurar [!DNL Anaplan] módulos, [!DNL Workfront Fusion] exibe os campos listados abaixo. Junto com esses, [!DNL Anaplan] Os campos podem ser exibidos, dependendo de fatores como seu nível de acesso no aplicativo ou serviço. Um título em negrito em um módulo indica um campo obrigatório.
...
<table style="table-layout:auto">
 ...
 <tbody> 
  <tr> 
   ...
   <td>Para obter instruções sobre como criar uma conexão com o [!DNL Anaplan], consulte <a href="#connect-anaplan-to-workfront-fusion" class="MCXref xref">Conectar [!DNL Anaplan] para [!DNL Workfront Fusion]</a> neste artigo.</td> 
  </tr> 
  <tr> 
...
<table style="table-layout:auto">
    ...
    <tr>
        ...
        <td>Selecione ou mapeie a ID do Espaço de Trabalho Anaplan que contém a lista à qual você deseja adicionar um item.</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>Se a lista a qual você deseja adicionar itens tiver subconjuntos personalizados, selecione os subconjuntos aos quais deseja adicionar o item e selecione <b>[!UICONTROL Sim]</b> para adicionar o novo item a esse subconjunto.</td>
    </tr>
</table>

#### [!UICONTROL Fazer uma chamada de API personalizada]

Esse módulo permite executar uma chamada de API personalizada para o [!DNL Anaplan] API.
...
<table style="table-layout:auto">
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader">[!UICONTROL ID do Espaço de Trabalho]</td> 
   <td>Selecione ou mapeie a ID do Espaço de Trabalho Anaplan que contém o objeto que você deseja excluir.</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>Selecione o tipo de registro a ser lido.</p> 
    <ul> 
     ...
     <li> <p><b>Lista de modelos</b> </p> <p>Selecione ou mapeie as IDs do espaço de trabalho e o modelo que contêm a lista que você deseja ler e selecione a lista. No campo [!UICONTROL Tipo de dados], selecione se deseja ler dados ou metadados.</p> </li> 
...
Este módulo de ação atualiza um único registro no [!UICONTROL Anaplan].
  ...
  <tr> 
   ...
   <td> <p>Selecione o tipo de registro que deseja atualizar.</p> 
    <ul> 
     ...
     <li> <p><b>[!UICONTROL Ano fiscal atual do modelo]</b> </p> <p>Informe a ID do Espaço de Trabalho e a ID do Modelo para o qual deseja atualizar o ano fiscal e, em seguida, informe ou mapeie o novo ano para o modelo.</p> </li> 
    </ul> </td> 
  </tr> 
 </tbody> 
</table>
...
<tr>
<td role="rowheader">[!UICONTROL ID do Espaço de Trabalho]</td>
<td>Selecione ou mapeie a ID do [!DNL Anaplan] Espaço de trabalho no qual você deseja fazer upload de um arquivo.</td>
</tr>
<tr>
<td role="rowheader">[!UICONTROL ID de Modelo]</td>
  ...
  <tr> 
   ...
   <td> <p>Selecione o tipo de registro que deseja recuperar.</p> 
      <ul> 
       ...
       <li> <p><b>[!UICONTROL Listas de modelos]</b> </p> <p>Selecione ou mapeie a ID do espaço de trabalho e a ID do modelo que contém as listas de modelos que você deseja recuperar.</p> </li> 
       <li> <p><b>[!UICONTROL Calendário modelo]</b> </p> <p>Selecione ou mapeie a ID do espaço de trabalho que contém o calendário Modelo que você deseja recuperar.</p> </li> 
