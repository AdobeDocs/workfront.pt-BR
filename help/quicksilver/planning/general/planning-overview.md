...
Para obter a lista completa de artigos que contêm documentação sobre o Workfront Planning, consulte [Informações gerais sobre o Adobe Workfront Planning](/help/quicksilver/planning/planning-information.md).
...
* Atribua aos seguintes usuários um modelo de layout que inclua Planejamento no Menu Principal:

   * Atribua o modelo de layout aos usuários Light e Contribute.
...
* Atribua aos usuários uma licença do Workfront e permissões do Workfront Planning que lhes permitam visualizar ou criar objetos no Workfront Planning. Para obter mais informações sobre como conceder acesso e permitir que outras pessoas utilizem o Workfront Planning, consulte [Visão geral do acesso ao Adobe Workfront Planning](/help/quicksilver/planning/access/access-overview.md).
...
* **Espaço de trabalho**: uma coleção de tipos de registros que definem o ciclo de vida operacional de uma determinada organização. Um espaço de trabalho é a estrutura de trabalho de uma unidade organizacional.
...
* **Modelo de espaço de trabalho**: você pode criar um espaço de trabalho usando modelos predefinidos. Você pode usar os tipos de registros e campos predefinidos que vêm em um modelo ou pode adicionar os seus próprios.
  ...
  Para obter mais informações, consulte [Lista de modelos de espaços de trabalho](/help/quicksilver/planning/architecture/workspace-templates.md).
...
* **Tipos de registros conectados**, **Registros conectados** e **Campos conectados**: você pode criar uma conexão entre as seguintes entidades no Workfront Planning:
  ...
  Depois que você estabelece uma conexão entre os tipos de registro, é possível conectar registros individuais ou objetos desses tipos entre si. A conexão entre os registros é exibida como um campo de registro conectado, ou uma conexão.
...
* **Campos de pesquisa** (ou campos vinculados): depois que você estabelece a conexão entre dois tipos de registro e conecta registros individuais, é possível fazer referência aos campos dos registros conectados a partir do registro que você está conectando.
  ...
  >* Não é possível adicionar os seguintes tipos de campo como campos de pesquisa do registro conectado ou tipo de objeto na Produção, <span class="preview"> mas você pode adicioná-los no ambiente de Visualização:</span>
  >   * Pessoas
...
* **Visualizações**: os registros são exibidos em sua respectiva página de tipo de registro em diferentes tipos de visualizações.
...
Para obter uma lista atualizada dos recursos lançados, consulte [atividade de lançamentos do Adobe Workfront Planning: índice do artigo](/help/quicksilver/product-announcements/product-releases/planning-release-activity/planning-release-activity-article-index.md).
...
* **Recursos de relatórios do Workfront Planning**: agora você pode visualizar as informações do Workfront Planning em um relatório no Workfront usando o painel de tela do Workfront. Para obter informações, consulte [Visão geral dos Painéis da Tela](/help/quicksilver/reports-and-dashboards/canvas-dashboards/canvas-dashboards-overview.md).
