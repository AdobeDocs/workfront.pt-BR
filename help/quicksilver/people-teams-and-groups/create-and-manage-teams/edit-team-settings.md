...
1. Nas configurações do grupo, você pode fazer os seguintes tipos de alterações:
   ...
   * Anexe um formulário personalizado. Para obter mais informações, consulte [Adicionar um formulário personalizado a um objeto](/help/quicksilver/workfront-basics/work-with-custom-forms/add-a-custom-form-to-an-object.md).
