...
description: Como um gerente de projeto, você pode determinar como a Condição de um projeto é calculada atualizando o Tipo de condição do projeto. A Condição do projeto é uma representação visual de como o projeto está progredindo.
author: Alina
