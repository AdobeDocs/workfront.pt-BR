...
Você pode editar um [!UICONTROL portfólio] na página de portfólio ou pode editar portfólios em uma lista.
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>[!UICONTROL Editar] acesso a Portfolio</p> <p>Observação: se você ainda não tiver acesso, pergunte ao administrador do [!DNL Workfront] se ele definiu restrições adicionais no seu nível de acesso. Para obter informações sobre acesso a portfólios no seu Nível de Acesso, consulte <a href="../../../administration-and-setup/add-users/configure-and-grant-access/grant-access-portfolios.md" class="MCXref xref">Conceder acesso aos portfólios</a>. Para obter informações sobre como um administrador do [!DNL Workfront] pode alterar seu nível de acesso, consulte <a href="../../../administration-and-setup/add-users/configure-and-grant-access/create-modify-access-levels.md" class="MCXref xref">Criar ou modificar níveis de acesso personalizados</a>. </p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">Permissões de objeto</td> 
   <td> <p>Permissões [!UICONTROL Manage] para um portfólio</p> <p> Para obter informações sobre como conceder permissões a portfólios, consulte <a href="../../../workfront-basics/grant-and-request-access-to-objects/share-a-portfolio.md" class="MCXref xref">Compartilhar um portfólio </a>. </p> <p>Para obter informações sobre como solicitar permissões adicionais, consulte <a href="../../../workfront-basics/grant-and-request-access-to-objects/request-access.md" class="MCXref xref">Solicitar acesso aos objetos </a>.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
1. Clique em **[!UICONTROL Portfolio]** e no nome de um portfólio para abri-lo.
1. (Opcional) Para editar informações limitadas sobre o portfólio, clique em **[!UICONTROL Detalhes do Portfolio]** no painel esquerdo.
   ...
   1. Para obter informações sobre os campos visíveis na seção [!UICONTROL Detalhes do Portfolio], continue editando o portfólio na caixa [!UICONTROL Editar Portfolio], conforme descrito abaixo.
   1. (Opcional) Se não houver formulários personalizados anexados ao portfólio, comece digitando o nome de um formulário no campo **[!UICONTROL Adicionar formulário personalizado]**, selecione-o quando ele for exibido na lista e clique em **[!UICONTROL Salvar alterações]**.
...
1. Para editar todas as informações sobre um ou mais portfólios, siga um destes procedimentos:
   ...
   * Clique no menu **[!UICONTROL Mais]** ao lado do nome do portfólio e depois em **[!UICONTROL Editar].**

     <!--   
     <p data-mc-conditions="QuicksilverOrClassic.Draft mode">(NOTE: this will change in NWE with a new Edit Portfolio UI)</p>   
     -->

   * Vá para uma lista de portfólios, selecione um ou mais portfólios que deseja editar e clique no ícone **[!UICONTROL Editar]** ![](assets/edit-icon.png) na parte superior da lista.
     ...
     -->
   A caixa de diálogo **[!UICONTROL Editar Portfolio]** é exibida.
...
1. Clique no menu suspenso **[!UICONTROL Adicionar Forms]** para selecionar um formulário personalizado e adicioná-lo ao portfólio.
   ...
   >[!NOTE]
   >
   >Dependendo de como o administrador do [!DNL Workfront] definiu as permissões para as seções no formulário personalizado, nem todos podem exibir ou editar os mesmos campos em um determinado formulário personalizado. As permissões para editar campos em uma seção de um formulário personalizado dependem das permissões que você tem no próprio portfólio. Para obter informações sobre a configuração de permissões em seções de um formulário personalizado, consulte [Criar um formulário com o designer de formulário](/help/quicksilver/administration-and-setup/customize-workfront/create-manage-custom-forms/form-designer/design-a-form/design-a-form.md).
...
1. Adicione um comentário no **[!UICONTROL Post e atualize o campo portfolio]**.
