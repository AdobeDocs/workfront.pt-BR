...
1. Em qualquer módulo do Adobe Workfront, clique em **Adicionar** ao lado do campo Connection.
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>Insira seu [!DNL Workfront] ID do cliente. Isso pode ser encontrado na área Aplicativos OAuth2 da área Configuração no Workfront. Abra o aplicativo específico ao qual você está se conectando para ver a ID do cliente.</td>
      </tr>
      <tr>
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     ...
     <tr data-mc-conditions=""> 
      ...
      <td>Habilite essa opção para excluir eventos criados ou atualizados usando o mesmo conector que esse módulo de acionador usa. Isso pode evitar situações em que um cenário pode ser acionado, fazendo com que ele se repita em um loop infinito.<p><b>NOTA</b>O tipo de registro Assignment não inclui essa opção.</p></td> 
     </tr> 
     <tr> 
