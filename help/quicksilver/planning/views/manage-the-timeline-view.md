...
1. Siga um destes procedimentos para navegar pela linha do tempo:
   ...
   * Selecione uma das seguintes opções no menu drop-down intervalo de tempo para atualizar os incrementos de tempo e atualizar a view:
     ...
     * **Mês**: exibe semanas e dias.
     ...
     >[!TIP]
     >
     >Dependendo do ambiente que você está usando para acessar a visualização da linha do tempo, os seguintes cenários existem:
     >
     >* No ambiente de Produção, a exibição da linha do tempo só exibe semanas personalizadas de acordo com trimestres clássicos. Se o administrador do Workfront ativar Trimestres personalizados na área Configuração, as informações da semana não serão exibidas na exibição de linha do tempo.
     >
     >* <span class="preview">No ambiente de Visualização, o modo de exibição de linha do tempo mostra semanas personalizadas de acordo com trimestres clássicos, por padrão. Se o administrador do Workfront ativar Trimestres personalizados e Semanas personalizadas na área Configuração, a exibição da linha do tempo exibirá os trimestres e semanas personalizados no Trimestre e no Mês. </span>
     >
...
1. Para criar registros na exibição de linha do tempo ou editar suas datas, siga um destes procedimentos:
   ...
   * Arraste e solte registros para atualizar sua posição e datas na linha do tempo. Mover as barras dos registros atualiza as datas de início e término imediatamente.
   ...
   >[!TIP]
   >
   >Não é possível redimensionar, arrastar e soltar registros na linha do tempo para tipos de objetos do Workfront e do Adobe Experience Manager exibidos em detalhamentos.
...
Você pode exibir registros conectados na visualização da linha do tempo de um registro usando o recurso Detalhamento. Detalhar os registros por suas conexões permite visualizar as linhas do tempo de outros registros conectados e entender como elas podem afetar o desempenho e os prazos de seus registros.
