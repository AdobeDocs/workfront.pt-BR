...
description: Crie uma visualização que mostre a diferença entre dois campos de data em um objeto ou entre um campo de data em um objeto e outro campo de data no objeto pai.
