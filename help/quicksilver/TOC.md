...
* Ágil {#agile}
   ...
   * Scrum em uma equipe ágil {#scrum}
      ...
      * Iterações {#iterations}
         ...
         * [Gerenciar comentários de iteração](agile/use-scrum-in-an-agile-team/iterations/manage-iteration-updates.md)
...
* Relatórios {#reporting}
   ...
   * data lake do Workfront {#data-lake}
      ...
      * [Compartilhar dados do data lake com ferramentas de business intelligence e data warehouses externos](reports-and-dashboards/data-lake/share-data-externally.md)
...
* Adobe Maestro {#adobe-maestro}
   ...
   * Registros do Adobe Maestro {#adobe-maestro-records}
      ...
      * [Adicionar miniaturas aos registros](maestro/records/add-thumbnails-to-records.md)
