...
Para obter informações gerais sobre como atribuir trabalho a usuários e Agentes de trabalho usando o Balanceador de carga de trabalho, consulte [Visão geral da atribuição de trabalho no Balanceador de carga de trabalho](../../resource-mgmt/workload-balancer/assign-work-in-workload-balancer.md).
