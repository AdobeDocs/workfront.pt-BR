...
description: Em um cenário do Adobe Workfront Fusion, você pode automatizar os workflows que usam [!DNL NetSuite], bem como conectá-lo a vários aplicativos e serviços de terceiros.
author: Becky
...
Em um [!DNL Adobe Workfront Fusion] , é possível automatizar workflows que usam [!DNL NetSuite], bem como conectá-lo a vários aplicativos e serviços de terceiros.
...
Para usar [!DNL NetSuite] módulos, você deve ter um [!DNL NetSuite] conta.



## [!DNL NetSuite] módulos e seus campos

Ao configurar [!DNL NetSuite] módulos, [!DNL Workfront Fusion] exibe os campos listados abaixo. Junto com esses, [!DNL NetSuite] podem ser exibidos, dependendo de fatores como seu nível de acesso no aplicativo ou serviço. Um título em negrito em um módulo indica um campo obrigatório.
...
Esse módulo de ação permite que você faça uma chamada autenticada personalizada para o [!DNL NetSuite] API. Dessa forma, você pode criar uma automação de fluxo de dados que não pode ser realizada pela outra [!DNL NetSuite] módulos.
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>Para obter instruções sobre como conectar seu [!DNL NetSuite] conta para o Workfront Fusion, consulte<a href="#create-a-connection-to-netsuite-in-a-workfront-fusion-netsuite-module" class="MCXref xref">Criar uma conexão com [!DNL NetSuite] em um módulo do Workfront Fusion NetSuite</a> neste artigo.</p> </td> 
  </tr> 
  <tr> 
